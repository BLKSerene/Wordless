...
class Wl_Settings_Word_Detokenization(wl_tree.Wl_Settings):
    def __init__(self, main):
        ...
        self.settings_global = self.main.settings_global['word_detokenizers']
        self.settings_default = self.main.settings_default['word_detokenization']
        self.settings_custom = self.main.settings_custom['word_detokenization']
        ...
        table_word_detokenizers.setRowCount(len(self.settings_global))
        ...
        self.button_word_detokenization_show_preview = QPushButton(self.tr('Show preview'), self)
        ...
        self.button_word_detokenization_show_preview.clicked.connect(self.preview_results_changed)
        ...
        layout_preview_settings.addWidget(self.button_word_detokenization_show_preview, 0, 3)
    ...
    def preview_changed(self):
        self.settings_custom['preview_lang'] = wl_conversion.to_lang_code(self.main, self.combo_box_word_detokenization_preview_lang.currentText())
        self.settings_custom['preview_samples'] = self.text_edit_word_detokenization_preview_samples.toPlainText()
        self.settings_custom['preview_results'] = self.text_edit_word_detokenization_preview_results.toPlainText()
    ...
    def preview_results_changed(self):
        if self.settings_custom['preview_samples']:
            if self.combo_box_word_detokenization_preview_lang.isEnabled():
                self.__dict__[f"combo_box_word_detokenizer_{self.settings_custom['preview_lang']}"].setEnabled(False)
                self.combo_box_word_detokenization_preview_lang.setEnabled(False)
                self.button_word_detokenization_show_preview.setEnabled(False)
    ...
    def update_gui(self, preview_samples, preview_results):
        self.__dict__[f"combo_box_word_detokenizer_{self.settings_custom['preview_lang']}"].setEnabled(True)
        self.combo_box_word_detokenization_preview_lang.setEnabled(True)
        self.button_word_detokenization_show_preview.setEnabled(True)
        self.text_edit_word_detokenization_preview_samples.setEnabled(True)

        self.button_word_detokenization_show_preview.setText(self.tr('Show preview'))
    ...
    def load_settings(self, defaults = False):
        ...
        if not defaults:
            ...
            self.combo_box_word_detokenization_preview_lang.setCurrentText(wl_conversion.to_lang_text(self.main, settings['preview_lang']))
            self.text_edit_word_detokenization_preview_samples.setText(settings['preview_samples'])
            self.text_edit_word_detokenization_preview_results.setText(settings['preview_results'])
