...
class Wl_Settings_Sentence_Tokenization(wl_settings.Wl_Settings_Node):
    def __init__(self, main):
        ...
        for i, lang in enumerate(self.settings_global):
            ...
            self.table_sentence_tokenizers.setItemDelegateForRow(i, wl_boxes.Wl_Item_Delegate_Combo_Box(
        ...
        group_box_sentence_tokenizer_settings.layout().addWidget(self.table_sentence_tokenizers, 0, 0)
