...
def test_dices_coeff():
    assert round(wordless_measures_effect_size.dices_coeff(main, 130, 3121 - 130, 143 - 130, -1), 2) == 0.08
...
def test_min_sensitivity():
    assert round(wordless_measures_effect_size.min_sensitivity(main, 17, 240, 1001, 1298742), 3) == 0.017
...
def test_pct_diff():
    assert round(wordless_measures_effect_size.pct_diff(main, 20, 1, 29954 - 20, 23691 - 1), 2) == 1481.83
