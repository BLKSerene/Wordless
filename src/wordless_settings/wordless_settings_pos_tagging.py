...
from wordless_text import wordless_word_tokenization, wordless_pos_tagging
...
# POS Tagging
class Wordless_Settings_Pos_Tagging(wordless_tree.Wordless_Settings):
...
# POS Tagging - Tagsets
class Wordless_Settings_Tagsets(wordless_tree.Wordless_Settings):
    def __init__(self, main):
        super().__init__(main)
