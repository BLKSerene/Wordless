...
from wordless_settings import (
    wordless_settings_general,
    wordless_settings_import,
    wordless_settings_export,
    wordless_settings_auto_detection,
    wordless_settings_data,
    wordless_settings_tags,
    wordless_settings_sentence_tokenization,
    wordless_settings_word_tokenization,
    wordless_settings_word_detokenization,
    wordless_settings_pos_tagging,
    wordless_settings_lemmatization,
    wordless_settings_stop_words,
    wordless_settings_measures,
    wordless_settings_figs
)
from wordless_widgets import wordless_button, wordless_layout, wordless_tree
...
class Wordless_Settings(QDialog):
    ...
    def __init__(self, main):
        ...
        self.settings_general = wordless_settings_general.Wordless_Settings_General(self.main)
        self.settings_import = wordless_settings_import.Wordless_Settings_Import(self.main)
        self.settings_export = wordless_settings_export.Wordless_Settings_Export(self.main)
        self.settings_auto_detection = wordless_settings_auto_detection.Wordless_Settings_Auto_Detection(self.main)
        self.settings_data = wordless_settings_data.Wordless_Settings_Data(self.main)
        self.settings_tags = wordless_settings_tags.Wordless_Settings_Tags(self.main)
        self.settings_sentence_tokenization = wordless_settings_sentence_tokenization.Wordless_Settings_Sentence_Tokenization(self.main)
        self.settings_word_tokenization = wordless_settings_word_tokenization.Wordless_Settings_Word_Tokenization(self.main)
        self.settings_word_detokenization = wordless_settings_word_detokenization.Wordless_Settings_Word_Detokenization(self.main)

        self.settings_pos_tagging = wordless_settings_pos_tagging.Wordless_Settings_Pos_Tagging(self.main)
        self.settings_tagsets = wordless_settings_pos_tagging.Wordless_Settings_Tagsets(self.main)

        self.settings_lemmatization = wordless_settings_lemmatization.Wordless_Settings_Lemmatization(self.main)
        self.settings_stop_words = wordless_settings_stop_words.Wordless_Settings_Stop_Words(self.main)

        self.settings_dispersion = wordless_settings_measures.Wordless_Settings_Dispersion(self.main)
        self.settings_adjusted_freq = wordless_settings_measures.Wordless_Settings_Adjusted_Freq(self.main)
        self.settings_statistical_significance = wordless_settings_measures.Wordless_Settings_Statistical_Significance(self.main)
        self.settings_effect_size = wordless_settings_measures.Wordless_Settings_Effect_Size(self.main)

        self.settings_figs = wordless_settings_figs.Wordless_Settings_Figs(self.main)
