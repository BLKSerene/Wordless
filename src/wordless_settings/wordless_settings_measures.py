...
# Measures - Dispersion
class Wordless_Settings_Dispersion(wordless_tree.Wordless_Settings):
...
class Wordless_Settings_Adjusted_Freq(wordless_tree.Wordless_Settings):
    def __init__(self, main):
        super().__init__(main)
...
class Wordless_Settings_Statistical_Significance(wordless_tree.Wordless_Settings):
    def __init__(self, main):
        super().__init__(main)
...
class Wordless_Settings_Effect_Size(wordless_tree.Wordless_Settings):
    def __init__(self, main):
        super().__init__(main)
