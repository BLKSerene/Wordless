...
from wordless_widgets import wordless_button, wordless_layout, wordless_table

class Wordless_Dialog_Results_Sort_Concordancer(wordless_dialog.Wordless_Dialog):
    def __init__(self, main, table):
        ...
        self.table_sort = wordless_table.Wordless_Table_Results_Sort_Conordancer(self, self.table)
