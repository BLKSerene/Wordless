...
from wl_widgets import wl_box, wl_button, wl_layout, wl_msg, wl_widgets
...
class Wl_Dialog_Results_Filter(wl_dialog.Wl_Dialog):
...
class Wl_Dialog_Results_Filter_Wordlist(Wl_Dialog_Results_Filter):
    def __init__(self, main, tab, table):
        ...
        if self.tab == 'wordlist':
            ...
            (self.label_len_token_min,
             ...
             self.checkbox_len_token_max_no_limit) = wl_widgets.wl_widgets_filter(
                self,
                filter_min = 1,
                filter_max = 100
            )
            ...
            (self.label_len_ngram_min,
             ...
             self.checkbox_len_ngram_max_no_limit) = wl_widgets.wl_widgets_filter(
                self,
                filter_min = 1,
                filter_max = 100
            )
        ...
        (self.label_freq_min,
         ...
         self.checkbox_freq_max_no_limit) = wl_widgets.wl_widgets_filter(
            self,
            filter_min = 0,
            filter_max = 1000000
        )
        ...
        (self.label_dispersion_min,
         ...
         self.checkbox_dispersion_max_no_limit) = wl_widgets.wl_widgets_filter_measures(
            self,
            filter_min = 0,
            filter_max = 1
        )
        ...
        (self.label_adjusted_freq_min,
         ...
         self.checkbox_adjusted_freq_max_no_limit) = wl_widgets.wl_widgets_filter(
            self,
            filter_min = 0,
            filter_max = 1000000
        )
        ...
        (self.label_num_files_found_min,
         ...
         self.checkbox_num_files_found_max_no_limit) = wl_widgets.wl_widgets_filter(
            self,
            filter_min = 1,
            filter_max = 100000
        )
    ...
    def filter_results(self):
        ...
        dialog_progress = wl_dialog_misc.Wl_Dialog_Progress_Results_Filter(self.main)
...
class Wl_Dialog_Results_Filter_Collocation(Wl_Dialog_Results_Filter):
    def __init__(self, main, tab, table):
        ...
        (self.label_len_collocate_min,
         ...
         self.checkbox_len_collocate_max_no_limit) = wl_widgets.wl_widgets_filter(
            self,
            filter_min = 1,
            filter_max = 100
        )
        ...
        (self.label_test_stat_min,
         ...
         self.checkbox_test_stat_max_no_limit) = wl_widgets.wl_widgets_filter_measures(self)
        ...
        (self.label_p_value_min,
         ...
         self.checkbox_p_value_max_no_limit) = wl_widgets.wl_widgets_filter_p_value(self)
        ...
        (self.label_bayes_factor_min,
         ...
         self.checkbox_bayes_factor_max_no_limit) = wl_widgets.wl_widgets_filter_measures(self)
        ...
        (self.label_effect_size_min,
         ...
         self.checkbox_effect_size_max_no_limit) = wl_widgets.wl_widgets_filter_measures(self)
...
class Wl_Dialog_Results_Filter_Keyword(Wl_Dialog_Results_Filter):
    def __init__(self, main, tab, table):
        ...
        (self.label_len_keyword_min,
         ...
         self.checkbox_len_keyword_max_no_limit) = wl_widgets.wl_widgets_filter(
            self,
            filter_min = 1,
            filter_max = 100
        )
