...
from wl_widgets import wl_button, wl_layout, wl_widgets

class Wl_Dialog_Context_Settings(wl_dialog.Wl_Dialog):
    def __init__(self, main, tab):
        ...
        (self.inclusion_checkbox_context_window_sync,
         ...
         self.inclusion_spin_box_context_window_right) = wl_widgets.wl_widgets_window(self)
        ...
        (self.exclusion_checkbox_context_window_sync,
         ...
         self.exclusion_spin_box_context_window_right) = wl_widgets.wl_widgets_window(self)
