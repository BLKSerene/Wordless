...
from wordless_text import wordless_sentence_tokenization, wordless_text, wordless_text_utils
...
def wordless_word_tokenize(main, text, lang,
    ...
    # Chinese & Japanese
        ...
        if flat_tokens:
            ...
            sentences = wordless_sentence_tokenization.wordless_sentence_tokenize(main, text, lang = lang)
    ...
    # Russian
        ...
        if flat_tokens:
            ...
            sentences = wordless_sentence_tokenization.wordless_sentence_tokenize(main, text, lang = 'rus')
    ...
    # Tibetan
        ...
        if flat_tokens:
            ...
            sentences = wordless_sentence_tokenization.wordless_sentence_tokenize(main, text, lang = 'bod')
    ...
    if not flat_tokens:
        for i, sentence in enumerate(tokens_multilevel):
            tokens_multilevel[i] = wordless_sentence_tokenization.wordless_clause_tokenize(main, sentence, lang)

    # Flatten tokens
    tokens_flat = list(wordless_misc.flatten_list(tokens_multilevel))
