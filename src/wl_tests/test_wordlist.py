...
def test_wordlist():
    ...
    for i, file_test in enumerate(main.settings_custom['files']['files_open']):
        ...
        print(f'''Start testing Wordlist for file "{file_test['name']}"... ''', end = '')
    ...
    print(f'Testing for Wordlist has been completed! (In {round(time.time() - time_start_total, 2)} seconds)')
