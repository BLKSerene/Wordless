...
def test_pos_tag(lang, pos_tagger, show_results = False):
    ...
    if lang == 'zho_cn':
        ...
        assert tokens_tagged_universal == [('Het', 'X'), ('Nederlands', 'X'), ('is', 'X'), ('een', 'X'), ('West-Germaanse', 'X'), ('taal', 'X'), ('en', 'X'), ('de', 'X'), ('moedertaal', 'X'), ('van', 'X'), ('de', 'X'), ('meeste', 'X'), ('inwoners', 'X'), ('van', 'X'), ('Nederland', 'X'), (',', 'X'), ('België', 'X'), ('en', 'X'), ('Suriname', 'X'), ('.', 'X')]
    elif lang == 'eng':
        if pos_tagger == 'NLTK - Perceptron POS Tagger':
            ...
            assert tokens_tagged_universal == [('English', 'PROPN'), ('is', 'VERB'), ('a', 'DET'), ('West', 'PROPN'), ('Germanic', 'PROPN'), ('language', 'NOUN'), ('that', 'DET'), ('was', 'VERB'), ('first', 'ADV'), ('spoken', 'VERB'), ('in', 'ADP/SCONJ'), ('early', 'ADJ'), ('medieval', 'ADJ'), ('England', 'PROPN'), ('and', 'CCONJ'), ('eventually', 'ADV'), ('became', 'VERB'), ('a', 'DET'), ('global', 'ADJ'), ('lingua', 'NOUN'), ('franca.[4][5', 'PROPN'), (']', 'PUNCT')]
    elif lang == 'fra':
        ...
        assert tokens_tagged_universal == [('Le', 'DET'), ('français', 'ADJ'), ('est', 'AUX'), ('une', 'DET'), ('langue', 'NOUN'), ('indo-européenne', 'ADJ'), ('de', 'X'), ('la', 'DET'), ('famille', 'NOUN'), ('des', 'X'), ('langues', 'NOUN'), ('romanes', 'ADJ'), ('.', 'X')]
    elif lang == 'deu':
        ...
        assert tokens_tagged_universal == [('Η', 'X'), ('ελληνική', 'X'), ('γλώσσα', 'X'), ('ανήκει', 'X'), ('στην', 'X'), ('ινδοευρωπαϊκή', 'X'), ('οικογένεια[9', 'X'), (']', 'X'), ('και', 'CCONJ'), ('συγκεκριμένα', 'ADV'), ('στον', 'X'), ('ελληνικό', 'X'), ('κλάδο', 'X'), (',', 'PUNCT'), ('μαζί', 'ADV'), ('με', 'ADP'), ('την', 'X'), ('τσακωνική', 'X'), (',', 'PUNCT'), ('ενώ', 'SCONJ'), ('είναι', 'X'), ('η', 'X'), ('επίσημη', 'X'), ('γλώσσα', 'X'), ('της', 'X'), ('Ελλάδος', 'X'), ('και', 'CCONJ'), ('της', 'X'), ('Κύπρου', 'X'), ('.', 'PUNCT')]
    elif lang == 'ita':
        ...
        assert tokens_tagged_universal == [("L'", 'DET'), ('italiano', 'NOUN'), ('(', 'X'), ('[', 'X'), ('itaˈljaːno][Nota', 'NOUN'), ('1', 'NUM'), (']', 'X'), ('ascolta[?·info', 'X'), (']', 'X'), (')', 'X'), ('è', 'VERB'), ('una', 'DET'), ('lingua', 'NOUN'), ('romanza', 'NOUN'), ('parlata', 'ADJ'), ('principalmente', 'X'), ('in', 'X'), ('Italia', 'X'), ('.', 'X')]
    elif lang == 'jpn':
        ...
        assert tokens_tagged_universal == [('Lietuvių', 'X'), ('kalba', 'X'), ('–', 'X'), ('iš', 'X'), ('baltų', 'X'), ('prokalbės', 'X'), ('kilusi', 'X'), ('lietuvių', 'X'), ('tautos', 'X'), ('kalba', 'X'), (',', 'X'), ('kuri', 'X'), ('Lietuvoje', 'X'), ('yra', 'X'), ('valstybinė', 'X'), (',', 'X'), ('o', 'X'), ('Europos', 'X'), ('Sąjungoje', 'X'), ('–', 'X'), ('viena', 'X'), ('iš', 'X'), ('oficialiųjų', 'X'), ('kalbų', 'X'), ('.', 'X')]
    elif lang == 'nob':
        ...
        assert tokens_tagged_universal == [('Bokmål', 'X'), ('er', 'AUX'), ('en', 'X'), ('varietet', 'NOUN'), ('av', 'X'), ('norsk', 'ADJ'), ('språk', 'NOUN'), ('.', 'X')]
    elif lang == 'por':
        ...
        assert tokens_tagged_universal == [('A', 'X'), ('língua', 'X'), ('portuguesa', 'X'), (',', 'X'), ('também', 'ADV'), ('designada', 'X'), ('português', 'X'), (',', 'X'), ('é', 'X'), ('uma', 'X'), ('língua', 'X'), ('românica', 'X'), ('flexiva', 'X'), ('ocidental', 'X'), ('originada', 'X'), ('no', 'X'), ('galego-português', 'X'), ('falado', 'X'), ('no', 'X'), ('Reino', 'X'), ('da', 'X'), ('Galiza', 'X'), ('e', 'X'), ('no', 'X'), ('norte', 'X'), ('de', 'ADP'), ('Portugal', 'X'), ('.', 'X')]
    elif lang == 'rus':
        if pos_tagger == 'NLTK - Perceptron POS Tagger':
        ...
        assert tokens_tagged_universal == [('El', 'DET'), ('español', 'NOUN'), ('o', 'X'), ('castellano', 'NOUN'), ('es', 'AUX'), ('una', 'DET'), ('lengua', 'NOUN'), ('romance', 'NOUN'), ('procedente', 'ADJ'), ('del', 'X'), ('latín', 'NOUN'), ('hablado', 'ADJ'), ('.', 'PUNCT')]
    elif lang == 'tha':
