...
def test_sentence_tokenize(lang, sentence_tokenizer):
    ...
    if lang == 'afr':
        ...
        assert sentences == ['日本語（にほんご、にっぽんご[注 2]、英: Japanese）は、主に日本国内や日本人同士の間で使用されている言語。', '日本は法令によって公用語を規定していないが、法令その他の公用文は全て日本語で記述され、各種法令[10]において日本語を用いることが規定され、学校教育においては「国語」の教科として学習を行う等、事実上、日本国内において唯一の公用語となっている。']
    elif lang == 'kan':
        ...
        assert sentences == ['El español o castellano es una lengua romance procedente del latín hablado.', 'Pertenece al grupo ibérico y es originaria de Castilla, reino medieval de la península ibérica.', 'Se conoce también informalmente como «castilla»,nota 1\u200b31\u200b32\u200b en algunas áreas rurales e indígenas de América,33\u200b pues el español se empezó a enseñar poco después de la incorporación de los nuevos territorios a la Corona de Castilla.34\u200b35\u200b36\u200b37\u200b38\u200b39\u200b']
    elif lang == 'swe':
        ...
        assert sentences == ['Tiếng Việt (chữ Nôm: 㗂越), cũng gọi là tiếng Việt Nam (㗂越南),[5] tiếng Kinh (㗂京) hay Việt ngữ (越語) là ngôn ngữ của người Việt và là ngôn ngữ chính thức tại Việt Nam.', 'Đây là tiếng mẹ đẻ của khoảng 85% dân cư Việt Nam cùng với hơn 4 triệu Việt kiều.', 'Tiếng Việt còn là ngôn ngữ thứ hai của các dân tộc thiểu số tại Việt Nam và là ngôn ngữ dân tộc thiểu số tại Cộng hòa Séc.']
    elif lang == 'yor':
