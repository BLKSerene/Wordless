...
12|[OpenCC](https://github.com/BYVoid/OpenCC)                            |1.1.1  |Carbo Kuo (郭家宝)|[Apache-2.0](https://github.com/BYVoid/OpenCC/blob/master/LICENSE)
...
26|[spacy-pkuseg](https://github.com/explosion/spacy-pkuseg)             |0.0.31 |Ruixuan Luo (罗睿轩), Jingjing Xu (许晶晶),<br>Xuancheng Ren (任宣丞), Yi Zhang (张艺),<br>Zhiyuan Zhang (张之远), Bingzhen Wei (位冰镇),<br>Xu Sun (孙栩)|[MIT](https://github.com/explosion/spacy-pkuseg/blob/master/LICENSE)
