...
def test_wl_settings_tables():
    ...
    settings_tables.load_settings(defaults = False)
...
def test_wl_settings_tables_profiler():
    ...
    settings_tables_profiler.load_settings(defaults = False)
...
def test_wl_settings_tables_concordancer():
    ...
    settings_tables_concordancer.load_settings(defaults = False)
...
def test_wl_settings_tables_parallel_concordancer():
    ...
    settings_tables_parallel_concordancer.load_settings(defaults = False)
...
def test_wl_settings_tables_dependency_parser():
    ...
    settings_tables_dependency_parser.load_settings(defaults = False)
...
def test_wl_settings_tables_wordlist_generator():
    ...
    settings_tables_wordlist_generator.load_settings(defaults = False)
...
def test_wl_settings_tables_ngram_generator():
    ...
    settings_tables_ngram_generator.load_settings(defaults = False)
...
def test_wl_settings_tables_collocation_extractor():
    ...
    settings_tables_collocation_extractor.load_settings(defaults = False)
...
def test_wl_settings_tables_colligation_extractor():
    ...
    settings_tables_colligation_extractor.load_settings(defaults = False)
...
def test_wl_settings_tables_keyword_extractor():
    ...
    settings_tables_keyword_extractor.load_settings(defaults = False)
