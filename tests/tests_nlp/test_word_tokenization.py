...
def test_word_tokenize(lang, word_tokenizer):
    ...
    match lang:
        ...
        case 'zho_cn':
            match word_tokenizer:
                case 'pkuseg_zho':
                    assert tokens == ['汉语', '又', '称', '华语', '[6]', '[7]', '，', '是', '来自', '汉', '民族', '的', '语言', '[', '8', ']', '[', '7', ']', '[', '9', ']', '。']
        ...
        case 'zho_tw':
            match word_tokenizer:
                case 'pkuseg_zho':
                    assert tokens == ['漢語', '又', '稱', '華語', '[6]', '[7]', '，', '是', '來自', '漢', '民族', '的', '語言', '[8]', '[', '7', ']', '[', '9', ']', '。']
                case 'wordless_zho_char':
