...
def test_syl_tokenize(lang, syl_tokenizer):
    ...
    match lang:
        ...
        case 'asm':
            assert syls_tokens == [('অস', 'মী', 'য়া'), ('ভা', 'ষা'), ('(',), ('ইং', 'ৰা', 'জী'), (':',), ('Assamese',), ('language',), (')',), ('হৈ', 'ছে'), ('সক', 'লো', 'ত', 'কৈ'), ('পূ', 'ৰ্বী', 'য়'), ('ভা', 'ৰ', 'তী', 'য়', 'আ', 'ৰ্য'), ('ভা', 'ষা'), ('তথা',), ('অস', 'মৰ'), ('ৰা', 'জ্যিক'), ('ভা', 'ষা।')]
        case 'eus':
        ...
        case 'kan':
            assert syls_tokens == [('ದ್ರಾ', 'ವಿಡ'), ('ಭಾ', 'ಷೆ', 'ಗ', 'ಳ', 'ಲ್ಲಿ'), ('ಪ್ರಾ', 'ಮು', 'ಖ್ಯ', 'ವು', 'ಳ್ಳ'), ('ಭಾ', 'ಷೆ', 'ಯೂ'), ('ಭಾ', 'ರ', 'ತದ'), ('ಪು', 'ರಾ', 'ತ', 'ನ', 'ವಾದ'), ('ಭಾ', 'ಷೆ', 'ಗ', 'ಳ', 'ಲ್ಲಿ'), ('ಒಂ', 'ದೂ'), ('ಆಗಿ', 'ರುವ'), ('ಕನ್ನಡ',), ('ಭಾ', 'ಷೆ', 'ಯ', 'ನ್ನು'), ('ಅದರ',), ('ವಿ', 'ವಿಧ'), ('ರೂ', 'ಪ', 'ಗ', 'ಳ', 'ಲ್ಲಿ'), ('ಸು', 'ಮಾ', 'ರು'), ('೪೫',), ('ದಶ', 'ಲ', 'ಕ್ಷ'), ('(',), ('೪',), ('.',), ('೫',), ('ಕೋ', 'ಟಿ'), (')',), ('ಜನ', 'ರು'), ('ಆಡು',), ('ನು', 'ಡಿ', 'ಯಾ', 'ಗಿ'), ('ಬಳ', 'ಸು', 'ತ್ತ', 'ಲಿ', 'ದ್ದಾ', 'ರೆ'), ('.',)]
        case 'lav':
        ...
        case 'mar':
            assert syls_tokens == [('मरा', 'ठी'), ('भा', 'षा'), ('ही',), ('इं', 'डो', 'यु', 'रो', 'पीय'), ('भा', 'षा', 'कु', 'ळा', 'तील'), ('एक',), ('भा', 'षा'), ('आहे',), ('.',)]
        case 'mon_cyrl':
        ...
        case 'ori':
            assert syls_tokens == [('ଓଡ଼ିଆ',), ('(',), ('ଇଂ', 'ରା', 'ଜୀ'), ('ଭା', 'ଷା', 'ରେ'), ('Odia',), ('/əˈdiːə/',), ('or',), ('Oriya',), ('/ɒˈriːə/',), (',',), (')',), ('ଇଣ୍ଡୋ', 'ଇ', 'ଉ', 'ରୋ', 'ପୀୟ'), ('ଭା', 'ଷା', 'ଗୋ', 'ଷ୍ଠୀ'), ('ଅନ୍ତ', 'ର୍ଗତ'), ('ଏକ',), ('ଇଣ୍ଡୋ', 'ଆ', 'ର୍ଯ୍ୟ'), ('ଭା', 'ର', 'ତୀୟ'), ('ଭା', 'ଷା'), ('।',)]
        case 'pan_guru':
            assert syls_tokens == [('ਪੰਜਾ', 'ਬੀ'), ('ਭਾ', 'ਸ਼ਾ'), ('(',), ('ਸ਼ਾ', 'ਹ', 'ਮੁ', 'ਖੀ'), ('ਲਿ', 'ਪੀ'), (':',), ('\u200eپنجابی',), (',',), ('ਪੰਜਾ', 'ਬੀ'), (')',), ('ਪੰਜਾਬ',), ('ਦੀ',), ('ਭਾ', 'ਸ਼ਾ'), ('ਹੈ',), (',',), ('ਜਿਸ',), ('ਨੂੰ',), ('ਪੰਜਾਬ',), ('ਖੇ', 'ਤਰ'), ('ਦੇ',), ('ਵਸ', 'ਨੀਕ'), ('ਜਾਂ',), ('ਸੰਬੰਧਿਤ',), ('ਲੋਕ',), ('ਬੋ', 'ਲ', 'ਦੇ'), ('ਹਨ।',), ('[',), ('18',), (']',)]
        case 'pol':
        ...
        case 'san':
            assert syls_tokens == [('सं', 'स्कृ', 'तं'), ('जगत',), ('एक', 'त', 'मा', 'ति', 'प्र', 'ा', 'ची', 'ना'), ('समृ', 'द्धा'), ('शा', 'स्त्री', 'या'), ('च',), ('भा', 'षा', 'सु'), ('वर्त', 'ते।')]
        case 'srp_cyrl':
