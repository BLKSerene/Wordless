...
def test_stanza_urd():
    test_stanza.wl_test_stanza(
        ...
        results_pos_tag = [('اُردُو', 'NNP'), ('[', 'SYM'), ('8', 'QC'), (']', 'SYM'), ('برصغیر', 'NN'), ('کی', 'PSP'), ('معیاری', 'JJ'), ('زبانوں', 'NN'), ('میں', 'PSP'), ('سے', 'PSP'), ('ایک', 'QC'), ('ہے', 'VM'), ('۔', 'SYM')],
        results_pos_tag_universal = [('اُردُو', 'PROPN'), ('[', 'PUNCT'), ('8', 'NUM'), (']', 'PUNCT'), ('برصغیر', 'NOUN'), ('کی', 'ADP'), ('معیاری', 'ADJ'), ('زبانوں', 'NOUN'), ('میں', 'ADP'), ('سے', 'ADP'), ('ایک', 'NUM'), ('ہے', 'AUX'), ('۔', 'PUNCT')],
        results_lemmatize = ['اُردُو', '(', '8', ')', 'برصغیر', 'کا', 'معیاری', 'زبان', 'میں', 'سے', 'ایک', 'ہے', '۔'],
        results_dependency_parse = [('اُردُو', 'ایک', 'nsubj', 10), ('[', '8', 'punct', 1), ('8', 'اُردُو', 'nummod', -2), (']', '8', 'punct', -1), ('برصغیر', 'زبانوں', 'nmod', 3), ('کی', 'برصغیر', 'case', -1), ('معیاری', 'زبانوں', 'amod', 1), ('زبانوں', 'ایک', 'obl', 3), ('میں', 'زبانوں', 'case', -1), ('سے', 'زبانوں', 'case', -2), ('ایک', 'ایک', 'root', 0), ('ہے', 'ایک', 'cop', -1), ('۔', 'ایک', 'punct', -2)]
    )
