# ----------------------------------------------------------------------
# Wordless: Tests - NLP - Stanza - Welsh
...
def test_stanza_cym():
    test_stanza.wl_test_stanza(
        ...
        results_pos_tag = [('Yng', 'prep'), ('Nghyfrifiad', 'noun'), ('y', 'art'), ('DU', 'place'), ('(', 'punct'), ('2011', 'num'), (')', 'punct'), (',', 'punct'), ('darganfuwyd', 'verb'), ('bod', 'verbnoun'), ('19', 'num'), ('%', 'sym'), ('(', 'punct'), ('562,000', 'num'), (')', 'punct'), ('o', 'prep'), ('breswylwyr', 'noun'), ('Cymru', 'place'), ('(', 'punct'), ('tair', 'num'), ('blwydd', 'noun'), ('a', 'cconj'), ('throsodd', 'verb'), (')', 'punct'), ('yn', 'impf'), ('gallu', 'verbnoun'), ('siarad', 'verbnoun'), ('Cymraeg', 'noun'), ('.', 'punct')],
        results_pos_tag_universal = [('Yng', 'ADP'), ('Nghyfrifiad', 'NOUN'), ('y', 'DET'), ('DU', 'PROPN'), ('(', 'PUNCT'), ('2011', 'NUM'), (')', 'PUNCT'), (',', 'PUNCT'), ('darganfuwyd', 'VERB'), ('bod', 'NOUN'), ('19', 'NUM'), ('%', 'SYM'), ('(', 'PUNCT'), ('562,000', 'NUM'), (')', 'PUNCT'), ('o', 'ADP'), ('breswylwyr', 'NOUN'), ('Cymru', 'PROPN'), ('(', 'PUNCT'), ('tair', 'NUM'), ('blwydd', 'NOUN'), ('a', 'CCONJ'), ('throsodd', 'VERB'), (')', 'PUNCT'), ('yn', 'AUX'), ('gallu', 'NOUN'), ('siarad', 'NOUN'), ('Cymraeg', 'NOUN'), ('.', 'PUNCT')],
        results_lemmatize = ['yn', 'Cyfrifiad', 'y', 'TU', '(', '2011', ')', ',', 'darganfod', 'bod', '19', '%', '(', '562,000', ')', 'o', 'preswylwr', 'Cymru', '(', 'tri', 'blwydd', 'a', 'trosi', ')', 'yn', 'gallu', 'siarad', 'Cymraeg', '.'],
        results_dependency_parse = [('Yng', 'Nghyfrifiad', 'case', 1), ('Nghyfrifiad', 'darganfuwyd', 'obl', 7), ('y', 'DU', 'det', 1), ('DU', 'Nghyfrifiad', 'nmod', -2), ('(', '2011', 'punct', 1), ('2011', 'DU', 'appos', -2), (')', '2011', 'punct', -1), (',', 'darganfuwyd', 'punct', 1), ('darganfuwyd', 'darganfuwyd', 'root', 0), ('bod', 'darganfuwyd', 'advcl', -1), ('19', '%', 'nummod', 1), ('%', 'bod', 'nsubj', -2), ('(', '562,000', 'punct', 1), ('562,000', '%', 'appos', -2), (')', '562,000', 'punct', -1), ('o', 'breswylwyr', 'case', 1), ('breswylwyr', '%', 'nmod', -5), ('Cymru', 'breswylwyr', 'flat', -1), ('(', 'blwydd', 'punct', 2), ('tair', 'blwydd', 'nummod', 1), ('blwydd', 'breswylwyr', 'conj', -4), ('a', 'throsodd', 'cc', 1), ('throsodd', 'blwydd', 'conj', -2), (')', 'blwydd', 'punct', -3), ('yn', 'gallu', 'aux', 1), ('gallu', 'throsodd', 'xcomp', -3), ('siarad', 'gallu', 'xcomp', -1), ('Cymraeg', 'siarad', 'obj', -1), ('.', 'darganfuwyd', 'punct', -20)]
    )
