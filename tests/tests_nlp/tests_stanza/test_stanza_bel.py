# ----------------------------------------------------------------------
# Wordless: Tests - NLP - Stanza - Belarusian
...
def test_stanza_bel():
    test_stanza.wl_test_stanza(
        ...
        results_lemmatize = ['белару́скі', 'мо́ва', '—', 'нацыянальны', 'мова', 'беларус', ',', 'уваходзіць', 'у', 'індаеўрапейскі', 'моўны', 'сям’я', ',', 'славянскі', 'група', ',', 'усходнеславянскі', 'падгруп', '.'],
