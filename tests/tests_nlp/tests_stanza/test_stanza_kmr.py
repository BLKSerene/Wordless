# ----------------------------------------------------------------------
# Wordless: Tests - NLP - Stanza - Kurdish (Kurmanji)
...
def test_stanza_kmr():
    test_stanza.wl_test_stanza(
        ...
        results_pos_tag = [('Kurmancî', 'n'), (',', 'cm'), ('Kurdiya', 'n'), ('jorîn', 'n'), ('yan', 'cnjcoo'), ('jî', 'emph'), ('Kurdiya', 'n'), ('bakurî', 'n'), ('yek', 'num'), ('ji', 'pr'), ('zaravayên', 'n'), ('zimanê', 'n'), ('kurdî', 'adj'), ('ye', 'con'), ('ku', 'cnjsub'), ('ji', 'pr'), ('aliyê', 'n'), ('kurdan', 'n'), ('ve', 'post'), ('tê', 'vblex'), ('axaftin', 'vblex'), ('.', 'sent')],
        results_pos_tag_universal = [('Kurmancî', 'NOUN'), (',', 'PUNCT'), ('Kurdiya', 'NOUN'), ('jorîn', 'NOUN'), ('yan', 'CCONJ'), ('jî', 'PART'), ('Kurdiya', 'NOUN'), ('bakurî', 'NOUN'), ('yek', 'NUM'), ('ji', 'ADP'), ('zaravayên', 'NOUN'), ('zimanê', 'NOUN'), ('kurdî', 'ADJ'), ('ye', 'ADP'), ('ku', 'SCONJ'), ('ji', 'ADP'), ('aliyê', 'NOUN'), ('kurdan', 'NOUN'), ('ve', 'ADP'), ('tê', 'VERB'), ('axaftin', 'VERB'), ('.', 'PUNCT')],
        results_lemmatize = ['kurmancî', ',', 'kurdî', 'jorîn', 'yan', 'jî', 'kurdî', 'bakurî', 'yek', 'ji', 'zarava', 'ziman', 'kurdî', 'yê', 'ku', 'ji', 'alî', 'kurd', 've', 'hatin', 'axaftin', '.'],
        results_dependency_parse = [('Kurmancî', 'yek', 'nsubj', 8), (',', 'Kurmancî', 'punct', -1), ('Kurdiya', 'yek', 'nmod', 6), ('jorîn', 'Kurdiya', 'nmod:poss', -1), ('yan', 'Kurdiya', 'cc', 2), ('jî', 'yek', 'advmod', 3), ('Kurdiya', 'Kurdiya', 'conj', -4), ('bakurî', 'Kurdiya', 'nmod:poss', -1), ('yek', 'yek', 'root', 0), ('ji', 'zaravayên', 'case', 1), ('zaravayên', 'axaftin', 'nmod', 10), ('zimanê', 'zaravayên', 'nmod:poss', -1), ('kurdî', 'zimanê', 'amod', -1), ('ye', 'zimanê', 'case', -2), ('ku', 'axaftin', 'mark', 6), ('ji', 'aliyê', 'case', 1), ('aliyê', 'axaftin', 'nmod', 4), ('kurdan', 'aliyê', 'nmod:poss', -1), ('ve', 'aliyê', 'case', -2), ('tê', 'axaftin', 'aux', 1), ('axaftin', 'yek', 'advcl', -12), ('.', 'axaftin', 'punct', -1)]
    )
