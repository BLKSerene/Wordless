# ----------------------------------------------------------------------
# Wordless: Tests - NLP - Stanza - Wolof
...
def test_stanza_wol():
    test_stanza.wl_test_stanza(
        ...
        results_dependency_parse = [('Wolof', 'làkk', 'nsubj', 1), ('làkk', 'làkk', 'root', 0), ('la', 'làkk', 'cop', -1), ('wu', 'wax', 'obj', 3), ('ñu', 'wax', 'nsubj', 2), ('di', 'wax', 'aux', 1), ('wax', 'làkk', 'acl:relcl', -5), ('ci', 'Gàmbi', 'case', 1), ('Gàmbi', 'wax', 'obl', -2), ('(', 'Gàmbi', 'punct', 1), ('Gàmbi', 'Gàmbi', 'appos', -2), ('Wolof', 'Gàmbi', 'nmod', -1), (')', 'Gàmbi', 'punct', -2), (',', 'Gànnaar', 'punct', 1), ('Gànnaar', 'Gàmbi', 'conj', -6), ('(', 'Gànnaar', 'punct', 1), ('Gànnaar', 'Gànnaar', 'appos', -2), ('Wolof', 'Gànnaar', 'flat', -1), (')', 'Gànnaar', 'punct', -2), (',', 'Senegaal', 'punct', 2), ('ak', 'Senegaal', 'cc', 1), ('Senegaal', 'Gànnaar', 'conj', -7), ('(', 'Senegaal', 'punct', 1), ('Senegaal', 'Senegaal', 'appos', -2), ('Wolof', 'Senegaal', 'flat', -1), (')', 'Senegaal', 'punct', -2), ('.', 'làkk', 'punct', -25)]
    )
