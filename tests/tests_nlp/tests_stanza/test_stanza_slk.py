# ----------------------------------------------------------------------
# Wordless: Tests - NLP - Stanza - Slovak
...
def test_stanza_slk():
    test_stanza.wl_test_stanza(
        ...
        results_pos_tag = [('Slovenčina', 'SSfs1:r'), ('je', 'VKesc+'), ('oficiálne', 'Dx'), ('úradným', 'AAis7x'), ('jazykom', 'SSis7'), ('Slovenska', 'SSns2:r'), (',', 'Z'), ('Vojvodiny', 'SSfs2:r'), ('a', 'O'), ('od', 'Eu2'), ('1', '0'), ('.', 'Z'), ('mája', 'SSis2'), ('2004', '0'), ('jedným', 'NFis7'), ('z', 'Eu2'), ('jazykov', 'SSip2'), ('Európskej', 'AAfs2x:r'), ('únie', 'SSfs2'), ('.', 'Z')],
        results_pos_tag_universal = [('Slovenčina', 'PROPN'), ('je', 'AUX'), ('oficiálne', 'ADV'), ('úradným', 'ADJ'), ('jazykom', 'NOUN'), ('Slovenska', 'PROPN'), (',', 'PUNCT'), ('Vojvodiny', 'PROPN'), ('a', 'CCONJ'), ('od', 'ADP'), ('1', 'NUM'), ('.', 'PUNCT'), ('mája', 'NOUN'), ('2004', 'NUM'), ('jedným', 'NUM'), ('z', 'ADP'), ('jazykov', 'NOUN'), ('Európskej', 'ADJ'), ('únie', 'NOUN'), ('.', 'PUNCT')],
        results_lemmatize = ['slovenčin', 'byť', 'oficiálne', 'úradný', 'jazyk', 'slovensko', ',', 'vojvodiny', 'a', 'od', '1', '.', 'máj', '2004', 'jeden', 'z', 'jazyk', 'európsky', 'únia', '.'],
