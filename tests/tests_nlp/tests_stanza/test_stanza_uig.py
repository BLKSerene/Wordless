# ----------------------------------------------------------------------
# Wordless: Tests - NLP - Stanza - Uyghur
...
def test_stanza_uig():
    test_stanza.wl_test_stanza(
        ...
        results_pos_tag = [('ئۇيغۇر', 'N'), ('تىلى', 'N'), ('ئۇيغۇر', 'N'), ('جۇڭگو', 'N'), ('شىنجاڭ', 'N'), ('ئۇيغۇر', 'N'), ('ئاپتونوم', 'N'), ('رايونىنىڭ', 'N'), ('ئېيتقان', 'N'), ('بىر', 'M'), ('تۈركىي', 'N'), ('تىلى', 'N'), ('.', 'Y')],
        results_pos_tag_universal = [('ئۇيغۇر', 'NOUN'), ('تىلى', 'NOUN'), ('ئۇيغۇر', 'NOUN'), ('جۇڭگو', 'PROPN'), ('شىنجاڭ', 'PROPN'), ('ئۇيغۇر', 'NOUN'), ('ئاپتونوم', 'ADJ'), ('رايونىنىڭ', 'NOUN'), ('ئېيتقان', 'NOUN'), ('بىر', 'NUM'), ('تۈركىي', 'ADJ'), ('تىلى', 'NOUN'), ('.', 'PUNCT')],
        results_lemmatize = ['ئۇيغۇر', 'تىل', 'ئۇيغۇر', 'جۇڭگو', 'شىنجاڭ', 'ئۇيغۇر', 'ئاپتونوم', 'رايون', 'ئېيتقان', 'بىر', 'تۈركىي', 'تىل', '.'],
        results_dependency_parse = [('ئۇيغۇر', 'تىلى', 'nmod', 1), ('تىلى', 'تىلى', 'nsubj', 10), ('ئۇيغۇر', 'جۇڭگو', 'compound', 1), ('جۇڭگو', 'شىنجاڭ', 'compound', 1), ('شىنجاڭ', 'ئۇيغۇر', 'compound', 1), ('ئۇيغۇر', 'رايونىنىڭ', 'nmod', 2), ('ئاپتونوم', 'رايونىنىڭ', 'nmod', 1), ('رايونىنىڭ', 'تىلى', 'nmod:poss', 4), ('ئېيتقان', 'تىلى', 'amod', 3), ('بىر', 'تىلى', 'nummod', 2), ('تۈركىي', 'تىلى', 'amod', 1), ('تىلى', 'تىلى', 'root', 0), ('.', 'تىلى', 'punct', -1)]
    )
