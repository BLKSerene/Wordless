# ----------------------------------------------------------------------
# Wordless: Tests - NLP - Stanza - Telugu
...
def test_stanza_tel():
    results_pos_tag = [('తెలుగు', 'PROPN'), ('అనేది', 'PRON'), ('ద్రావిడ', 'NOUN'), ('భాషల', 'NOUN'), ('కుటుంబానికి', 'NOUN'), ('చెందిన', 'VERB'), ('భాష.', 'NOUN')]
    ...
    test_stanza.wl_test_stanza(
        ...
        results_dependency_parse = [('తెలుగు', 'భాష.', 'nsubj', 6), ('అనేది', 'చెందిన', 'obl', 4), ('ద్రావిడ', 'చెందిన', 'nsubj', 3), ('భాషల', 'చెందిన', 'obl', 2), ('కుటుంబానికి', 'చెందిన', 'obl', 1), ('చెందిన', 'భాష.', 'acl', 1), ('భాష.', 'భాష.', 'root', 0)]
    )
