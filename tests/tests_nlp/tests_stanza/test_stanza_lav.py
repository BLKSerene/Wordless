# ----------------------------------------------------------------------
# Wordless: Tests - NLP - Stanza - Latvian
...
def test_stanza_lav():
    test_stanza.wl_test_stanza(
        ...
        results_pos_tag = [('Latviešu', 'ncmpg2'), ('valoda', 'ncfsn4'), ('ir', 'vcnipii30an'), ('dzimtā', 'vmnpdfsnpsypn'), ('valoda', 'ncfsn4'), ('apmēram', 'r0q'), ('1,5', 'xn'), ('miljoniem', 'ncmpd1'), ('cilvēku', 'ncmpg1'), (',', 'zc'), ('galvenokārt', 'r0m'), ('Latvijā', 'npfsl4'), (',', 'zc'), ('kur', 'r0p'), ('tā', 'pd3fsnn'), ('ir', 'vcnipii30an'), ('vienīgā', 'affsnyp'), ('valsts', 'ncfsg6'), ('valoda', 'ncfsn4'), ('.', 'zs'), ('[', 'zb'), ('1', 'xn'), (']', 'zb'), ('[', 'zb'), ('3', 'xn'), (']', 'zb')],
