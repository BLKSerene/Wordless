# ----------------------------------------------------------------------
# Wordless: Tests - NLP - Stanza - Estonian
...
def test_stanza_est():
    test_stanza.wl_test_stanza(
        ...
        results_pos_tag = [('Eesti', 'S'), ('keelel', 'S'), ('on', 'V'), ('kaks', 'N'), ('suuremat', 'A'), ('murderühma', 'S'), ('(', 'Z'), ('põhjaeesti', 'S'), ('ja', 'J'), ('lõunaeesti', 'S'), (')', 'Z'), (',', 'Z'), ('mõnes', 'P'), ('käsitluses', 'S'), ('eristatakse', 'V'), ('ka', 'D'), ('kirderanniku', 'S'), ('murdeid', 'S'), ('eraldi', 'A'), ('murderühmana', 'S'), ('.', 'Z')],
        results_pos_tag_universal = [('Eesti', 'PROPN'), ('keelel', 'NOUN'), ('on', 'AUX'), ('kaks', 'NUM'), ('suuremat', 'ADJ'), ('murderühma', 'NOUN'), ('(', 'PUNCT'), ('põhjaeesti', 'NOUN'), ('ja', 'CCONJ'), ('lõunaeesti', 'NOUN'), (')', 'PUNCT'), (',', 'PUNCT'), ('mõnes', 'DET'), ('käsitluses', 'NOUN'), ('eristatakse', 'VERB'), ('ka', 'ADV'), ('kirderanniku', 'NOUN'), ('murdeid', 'NOUN'), ('eraldi', 'ADJ'), ('murderühmana', 'NOUN'), ('.', 'PUNCT')],
        results_lemmatize = ['Eesti', 'keel', 'olema', 'kaks', 'suurem', 'murde_rühm', '(', 'põhja_eesti', 'ja', 'lõuna_eesti', ')', ',', 'mõni', 'käsitlus', 'eristama', 'ka', 'kirder_annik', 'murre', 'eraldi', 'murde_rühm', '.'],
