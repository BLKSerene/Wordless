# ----------------------------------------------------------------------
# Wordless: Tests - NLP - Stanza - Buryat (Russia)
...
def test_stanza_bxr():
    results_pos_tag = [('Буряад', 'ADJ'), ('хэлэн', 'NOUN'), ('(', 'PUNCT'), ('буряад', 'ADJ'), ('-', 'PUNCT'), ('монгол', 'NOUN'), ('хэлэн', 'NOUN'), (')', 'PUNCT'), ('Алтайн', 'ADJ'), ('хэлэнэй', 'NOUN'), ('изагуурай', 'NOUN'), ('буряад', 'ADJ'), ('арад', 'NOUN'), ('түмэнһөө', 'NOUN'), ('хэрэглэгдэжэ', 'VERB'), ('бай', 'AUX'), ('монгол', 'NOUN'), ('хэлэнэй', 'NOUN'), ('бүлэгэй', 'NOUN'), ('xэлэн', 'NOUN'), ('-', 'PUNCT'), ('аялгуу', 'NOUN'), ('юм', 'AUX'), ('.', 'PUNCT')]
