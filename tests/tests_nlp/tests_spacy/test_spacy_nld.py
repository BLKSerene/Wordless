...
def test_spacy_nld():
    results_sentence_tokenize = ['Het Nederlands is een West-Germaanse taal, de meest gebruikte taal in Nederland en België, de officiële taal van Suriname en een van de drie officiële talen van België.', 'Binnen het Koninkrijk der Nederlanden is het Nederlands ook een officiële taal van Aruba, Curaçao en Sint-Maarten.']
    ...
    test_spacy.wl_test_spacy(
        ...
        results_dependency_parse = [('Het', 'Nederlands', 'det', 1), ('Nederlands', 'taal', 'nsubj', 4), ('is', 'taal', 'cop', 3), ('een', 'taal', 'det', 2), ('West-Germaanse', 'taal', 'amod', 1), ('taal', 'taal', 'ROOT', 0), (',', 'taal', 'punct', 4), ('de', 'taal', 'det', 3), ('meest', 'gebruikte', 'advmod', 1), ('gebruikte', 'taal', 'acl', 1), ('taal', 'taal', 'appos', -5), ('in', 'Nederland', 'case', 1), ('Nederland', 'taal', 'nmod', -2), ('en', 'België', 'cc', 1), ('België', 'Nederland', 'conj', -2), (',', 'taal', 'punct', 3), ('de', 'taal', 'det', 2), ('officiële', 'taal', 'amod', 1), ('taal', 'taal', 'conj', -13), ('van', 'Suriname', 'case', 1), ('Suriname', 'taal', 'nmod', -2), ('en', 'een', 'cc', 1), ('een', 'taal', 'conj', -17), ('van', 'talen', 'case', 4), ('de', 'talen', 'det', 3), ('drie', 'talen', 'nummod', 2), ('officiële', 'talen', 'amod', 1), ('talen', 'een', 'nmod', -5), ('van', 'België', 'case', 1), ('België', 'talen', 'nmod', -2), ('.', 'taal', 'punct', -25)]
    )
