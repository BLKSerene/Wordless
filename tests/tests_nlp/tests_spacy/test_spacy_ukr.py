# ----------------------------------------------------------------------
# Wordless: Tests - NLP - spaCy - Ukrainian
...
def test_spacy_ukr():
    results_pos_tag = [('Украї́нська', 'ADJ'), ('мо́ва', 'NOUN'), ('(', 'PUNCT'), ('МФА', 'NOUN'), (':', 'PUNCT'), ('[', 'PUNCT'), ('ukrɑ̽ˈjɪnʲsʲkɑ̽', 'X'), ('ˈmɔwɑ̽', 'X'), (']', 'PUNCT'), (',', 'PUNCT'), ('історичні', 'ADJ'), ('назви', 'NOUN'), ('—', 'PUNCT'), ('ру́ська[10][11][12', 'SYM'), (']', 'PUNCT'), ('[', 'SYM'), ('*', 'SYM'), ('1', 'NUM'), (']', 'PUNCT'), (')', 'SYM'), ('—', 'PUNCT'), ('національна', 'ADJ'), ('мова', 'NOUN'), ('українців', 'NOUN'), ('.', 'PUNCT')]
    ...
    test_spacy.wl_test_spacy(
        ...
        results_dependency_parse = [('Украї́нська', 'мо́ва', 'amod', 1), ('мо́ва', 'мова', 'nsubj', 21), ('(', 'МФА', 'punct', 1), ('МФА', 'мо́ва', 'parataxis', -2), (':', 'ukrɑ̽ˈjɪnʲsʲkɑ̽', 'punct', 2), ('[', 'ukrɑ̽ˈjɪnʲsʲkɑ̽', 'punct', 1), ('ukrɑ̽ˈjɪnʲsʲkɑ̽', 'МФА', 'parataxis', -3), ('ˈmɔwɑ̽', 'ukrɑ̽ˈjɪnʲsʲkɑ̽', 'flat:foreign', -1), (']', 'ukrɑ̽ˈjɪnʲsʲkɑ̽', 'punct', -2), (',', 'назви', 'punct', 2), ('історичні', 'назви', 'amod', 1), ('назви', 'МФА', 'parataxis', -8), ('—', 'ру́ська[10][11][12', 'punct', 1), ('ру́ська[10][11][12', 'МФА', 'parataxis', -10), (']', 'ру́ська[10][11][12', 'punct', -1), ('[', 'МФА', 'punct', -12), ('*', '1', 'punct', 1), ('1', 'МФА', 'parataxis', -14), (']', 'МФА', 'punct', -15), (')', 'МФА', 'punct', -16), ('—', 'мова', 'punct', 2), ('національна', 'мова', 'amod', 1), ('мова', 'мова', 'ROOT', 0), ('українців', 'мова', 'nmod', -1), ('.', 'мова', 'punct', -2)]
    )
