...
def test_spacy_hrv():
    test_spacy.wl_test_spacy(
        lang = 'hrv',
        results_sentence_tokenize_dependency_parser = ['Hrvatski jezik obuhvaća govoreni i pisani hrvatski standardni jezik i sve narodne govore kojima govore i pišu Hrvati.[4]', 'Povijesno, obuhvaća sve govore i sve književne jezike izgrađene na tim govorima, kojima su se služili Hrvati.[5][6]'],
        results_sentence_tokenize_sentence_recognizer = ['Hrvatski jezik obuhvaća govoreni i pisani hrvatski standardni jezik i sve narodne govore kojima govore i pišu Hrvati.[4] Povijesno, obuhvaća sve govore i sve književne jezike izgrađene na tim govorima, kojima su se služili Hrvati.[5][6]'],
