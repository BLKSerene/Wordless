...
def test_spacy_ell():
    ...
    test_spacy.wl_test_spacy(
        lang = 'ell',
        results_sentence_tokenize_dependency_parser = ['Η ελληνική γλώσσα ανήκει στην ινδοευρωπαϊκή οικογένεια[9] secεπίσης στο βαλκανικό γλωσσικό δεσμό.', 'ελληνική γλώσσα', ', έχουμε γραπτά κείμενα ήδη από τον 15ο αιώνα π.', 'Χ..'],
        results_sentence_tokenize_sentence_recognizer = ['Η ελληνική γλώσσα ανήκει στην ινδοευρωπαϊκή οικογένεια[9] secεπίσης στο βαλκανικό γλωσσικό δεσμό.', 'ελληνική γλώσσα, έχουμε γραπτά κείμενα ήδη από τον 15ο αιώνα π.', 'Χ..'],
