...
def test_spacy_fra():
    ...
    test_spacy.wl_test_spacy(
        lang = 'fra',
        results_sentence_tokenize_trf = ['Le français est une langue indo-européenne de la famille des langues romanes dont les locuteurs sont appelés « francophones ».', "Il est la cinquième langue parlée au monde après l'anglais, le mandarin, le hindi et l'espagnol."],
