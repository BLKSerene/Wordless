...
def test_spacy_deu():
    ...
    test_spacy.wl_test_spacy(
        ...
        results_pos_tag = [('Die', 'ART'), ('deutsche', 'ADJA'), ('Sprache', 'NN'), ('oder', 'KON'), ('Deutsch', 'NN'), ('[', '$('), ('dɔɪ̯tʃ][24', 'VVFIN'), (']', '$('), ('ist', 'VAFIN'), ('eine', 'ART'), ('westgermanische', 'ADJA'), ('Sprache', 'NN'), (',', '$,'), ('die', 'PRELS'), ('weltweit', 'ADJD'), ('etwa', 'ADV'), ('90', 'CARD'), ('bis', 'KON'), ('105', 'CARD'), ('Millionen', 'NN'), ('Menschen', 'NN'), ('als', 'APPR'), ('Muttersprache', 'NN'), ('und', 'KON'), ('weiteren', 'ADJA'), ('rund', 'ADV'), ('80', 'CARD'), ('Millionen', 'NN'), ('als', 'APPR'), ('Zweit-', 'TRUNC'), ('oder', 'KON'), ('Fremdsprache', 'NN'), ('dient', 'VVFIN'), ('.', '$.')],
        results_pos_tag_universal = [('Die', 'DET'), ('deutsche', 'ADJ'), ('Sprache', 'NOUN'), ('oder', 'CCONJ'), ('Deutsch', 'NOUN'), ('[', 'PUNCT'), ('dɔɪ̯tʃ][24', 'VERB'), (']', 'PUNCT'), ('ist', 'AUX'), ('eine', 'DET'), ('westgermanische', 'ADJ'), ('Sprache', 'NOUN'), (',', 'PUNCT'), ('die', 'PRON'), ('weltweit', 'ADV'), ('etwa', 'ADV'), ('90', 'NUM'), ('bis', 'CCONJ'), ('105', 'NUM'), ('Millionen', 'NOUN'), ('Menschen', 'NOUN'), ('als', 'ADP'), ('Muttersprache', 'NOUN'), ('und', 'CCONJ'), ('weiteren', 'ADJ'), ('rund', 'ADV'), ('80', 'NUM'), ('Millionen', 'NOUN'), ('als', 'ADP'), ('Zweit-', 'X'), ('oder', 'CCONJ'), ('Fremdsprache', 'NOUN'), ('dient', 'VERB'), ('.', 'PUNCT')],
        ...
        results_dependency_parse = [('Die', 'Sprache', 'nk', 2), ('deutsche', 'Sprache', 'nk', 1), ('Sprache', 'ist', 'sb', 6), ('oder', 'Sprache', 'cd', -1), ('Deutsch', 'oder', 'cj', -1), ('[', 'Sprache', 'punct', -3), ('dɔɪ̯tʃ][24', 'Sprache', 'nk', -4), (']', 'ist', 'punct', 1), ('ist', 'ist', 'ROOT', 0), ('eine', 'Sprache', 'nk', 2), ('westgermanische', 'Sprache', 'nk', 1), ('Sprache', 'ist', 'pd', -3), (',', 'Sprache', 'punct', -1), ('die', 'dient', 'sb', 19), ('weltweit', 'Millionen', 'mo', 5), ('etwa', '90', 'mo', 1), ('90', 'Millionen', 'nmc', 3), ('bis', '90', 'cd', -1), ('105', 'bis', 'cj', -1), ('Millionen', 'dient', 'oa', 13), ('Menschen', 'Millionen', 'nk', -1), ('als', 'Millionen', 'mnr', -2), ('Muttersprache', 'als', 'nk', -1), ('und', 'Muttersprache', 'cd', -1), ('weiteren', 'und', 'cj', -1), ('rund', 'Millionen', 'mo', 2), ('80', 'Millionen', 'nmc', 1), ('Millionen', 'Millionen', 'nk', -8), ('als', 'dient', 'mo', 4), ('Zweit-', 'oder', 'cj', 1), ('oder', 'Fremdsprache', 'cd', 1), ('Fremdsprache', 'als', 'nk', -3), ('dient', 'Sprache', 'rc', -21), ('.', 'ist', 'punct', -25)]
    )
