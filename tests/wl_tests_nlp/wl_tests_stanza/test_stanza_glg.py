# ----------------------------------------------------------------------
# Wordless: Tests - NLP - Stanza - Galician
...
def test_stanza_glg():
    test_stanza.wl_test_stanza(
        ...
        results_pos_tag = [('O', 'DA0MS0'), ('galego', 'AQ0MS0'), ('(', 'Fpa'), ('[', 'Fca'), ('ɡaˈleɣo̝', 'NP00000'), (']', 'Fca'), ('[', 'Fca'), ('1', 'Z'), (']', 'Fct'), (')', 'Fpt'), ('é', 'VSIP3S0'), ('unha', 'DI0FS0'), ('lingua', 'NCFS000'), ('indoeuropea', 'AQ0FS0'), ('que', 'PR0CN000'), ('pertence', 'VMIP3S0'), ('a', 'SPS00'), ('a', 'DA0FS0'), ('póla', 'NCFS000'), ('de', 'SPS00'), ('linguas', 'NCFP000'), ('románicas', 'AQ0FP0'), ('.', 'Fp')],
        results_pos_tag_universal = [('O', 'DET'), ('galego', 'ADJ'), ('(', 'PUNCT'), ('[', 'PUNCT'), ('ɡaˈleɣo̝', 'PROPN'), (']', 'PUNCT'), ('[', 'PUNCT'), ('1', 'NUM'), (']', 'PUNCT'), (')', 'PUNCT'), ('é', 'AUX'), ('unha', 'DET'), ('lingua', 'NOUN'), ('indoeuropea', 'ADJ'), ('que', 'PRON'), ('pertence', 'VERB'), ('a', 'ADP'), ('a', 'DET'), ('póla', 'NOUN'), ('de', 'ADP'), ('linguas', 'NOUN'), ('románicas', 'ADJ'), ('.', 'PUNCT')],
        results_lemmatize = ['o', 'galego', '(', '[', 'ɡaˈleɣo̝', ']', '[', '1', ']', ')', 'ser', 'un', 'lingua', 'indoeuropeo', 'que', 'pertencer', 'a', 'o', 'póla', 'de', 'lingua', 'románico', '.'],
        results_dependency_parse = [('O', 'galego', 'det', 1), ('galego', 'lingua', 'nsubj', 11), ('(', 'ɡaˈleɣo̝', 'punct', 2), ('[', 'ɡaˈleɣo̝', 'punct', 1), ('ɡaˈleɣo̝', 'galego', 'nmod', -3), (']', 'ɡaˈleɣo̝', 'punct', -1), ('[', '1', 'punct', 1), ('1', 'ɡaˈleɣo̝', 'nmod', -3), (']', '1', 'punct', -1), (')', '1', 'punct', -2), ('é', 'lingua', 'cop', 2), ('unha', 'lingua', 'det', 1), ('lingua', 'lingua', 'root', 0), ('indoeuropea', 'lingua', 'amod', -1), ('que', 'pertence', 'nsubj', 1), ('pertence', 'lingua', 'ccomp', -3), ('a', 'pertence', 'obj', -1), ('a', 'póla', 'det', 1), ('póla', 'a', 'nmod', -2), ('de', 'linguas', 'case', 1), ('linguas', 'póla', 'nmod', -2), ('románicas', 'linguas', 'amod', -1), ('.', 'lingua', 'punct', -10)]
    )
