...
def test_stanza_lzh():
    test_stanza.wl_test_stanza(
        ...
        results_dependency_parse = [('先', '民', 'nmod', 1), ('民', '言', 'nmod', 1), ('言', '傳', 'nsubj', 3), ('語', '言', 'conj', -1), ('，', '傳', 'advmod', 1), ('傳', '傳', 'root', 0), ('乎', '口', 'case', 1), ('口', '傳', 'obl', -2), ('耳', '傳', 'discourse:sp', -3), ('，', '至', 'nsubj', 1), ('至', '至', 'root', 0), ('結', '繩', 'amod', 1), ('繩', '至', 'obj', -2), ('以', '記', 'advmod', 1), ('記', '至', 'parataxis', -4), ('，', '事', 'nmod', 1), ('事', '記', 'obj', -2), ('日', '贅', 'obl:tmod', 1), ('贅', '至', 'parataxis', -8), ('，', '贅', 'compound:redup', -1), ('是', '結', 'nsubj', 1), ('結', '結', 'root', 0), ('繩', '，', 'nsubj', 4), ('之', '繩', 'case', -1), ('不', '足', 'advmod', 1), ('足', '，', 'aux', 1), ('，', '結', 'ccomp', -5), ('求', '求', 'root', 0), ('諸', '繪', 'nmod', 1), ('繪', '圖', 'nmod', 1), ('圖', '求', 'obj', -3), ('，', '圖', 'conj', -1), ('繪', '圖', 'amod', 1), ('圖', '圖', 'conj', -3), ('猶', '逾', 'advmod', 1), ('逾', '逾', 'root', 0), ('，', '逾', 'obj', -1), ('而', '創', 'cc', 1), ('創', '逾', 'conj', -3), ('字', '創', 'obj', -1), ('製', '逾', 'conj', -5), ('文', '製', 'obj', -1), ('，', '文', 'flat', -1), ('金', '文', 'conj', -2), ('石', '金', 'flat', -1), ('竹', '帛', 'nmod', 1), ('帛', '逾', 'conj', -11), ('載', '帛', 'flat', -1), ('之', '帛', 'case', -2), ('，', '創', 'obj', -11), ('自', '劉', 'case', 1), ('劉', '書', 'obl', 3), ('漢', '劉', 'flat', -1), ('而', '書', 'cc', 1), ('書', '逾', 'conj', -19), ('諸', '書', 'iobj', -1), ('紙', '書', 'obj', -2), ('。', '書', 'discourse:sp', -3)]
    )
