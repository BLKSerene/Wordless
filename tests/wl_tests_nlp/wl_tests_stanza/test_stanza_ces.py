# ----------------------------------------------------------------------
# Wordless: Tests - NLP - Stanza - Czech
...
def test_stanza_ces():
    test_stanza.wl_test_stanza(
        ...
        results_pos_tag = [('Čeština', 'NNFS1-----A----'), ('neboli', 'J^-------------'), ('český', 'AAIS1----1A----'), ('jazyk', 'NNIS1-----A----'), ('je', 'VB-S---3P-AA---'), ('západoslovanský', 'AAIS1----1A----'), ('jazyk', 'NNIS1-----A----'), (',', 'Z:-------------'), ('nejbližší', 'AAFS6----3A----'), ('slovenštině', 'NNFS6-----A----'), (',', 'Z:-------------'), ('poté', 'Db-------------'), ('lužické', 'AAFS6----1A----'), ('srbštině', 'NNFS6-----A----'), ('a', 'J^-------------'), ('polštině', 'NNFS6-----A----'), ('.', 'Z:-------------')],
