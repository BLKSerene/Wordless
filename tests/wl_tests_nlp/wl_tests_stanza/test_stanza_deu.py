# ----------------------------------------------------------------------
# Wordless: Tests - NLP - Stanza - German
...
def test_stanza_deu():
    test_stanza.wl_test_stanza(
        ...
        results_pos_tag_universal = [('Das', 'DET'), ('Deutsche', 'PROPN'), ('ist', 'AUX'), ('eine', 'DET'), ('plurizentrische', 'ADJ'), ('Sprache', 'NOUN'), (',', 'PUNCT'), ('enthält', 'VERB'), ('also', 'ADV'), ('mehrere', 'PRON'), ('Standardvarietäten', 'NOUN'), ('in', 'ADP'), ('verschiedenen', 'ADJ'), ('Regionen', 'NOUN'), ('.', 'PUNCT')],
        results_lemmatize = ['der', 'deutsch', 'sein', 'ein', 'plurizentrisch', 'Sprache', ',', 'enthalten', 'also', 'mehrere', 'Standardvarietät', 'in', 'verschieden', 'Region', '.'],
