# ----------------------------------------------------------------------
# Wordless: Tests - NLP - Stanza - Turkish
...
def test_stanza_tur():
    test_stanza.wl_test_stanza(
        ...
        results_pos_tag = [('Türkçe', 'Prop'), ('ya', 'Conj'), ('da', 'Conj'), ('Türk', 'Adj'), ('dili', 'Noun'), (',', 'Punc'), ('Güneydoğu', 'Adj'), ('Avrupa', 'Prop'), ('ve', 'Conj'), ('Batı', 'Adj'), ("Asya'da", 'Prop'), ('konuşulan', 'Verb'), (',', 'Punc'), ('Türk', 'Adj'), ('dilleri', 'Noun'), ('dil', 'Noun'), ('ailesine', 'Noun'), ('ait', 'PCDat'), ('sondan', 'Noun'), ('eklemeli', 'Adj'), ('bir', 'ANum'), ('dil', 'Noun'), ('.', 'Punc'), ('[12]', 'Punc')],
        results_pos_tag_universal = [('Türkçe', 'PROPN'), ('ya', 'CCONJ'), ('da', 'CCONJ'), ('Türk', 'ADJ'), ('dili', 'NOUN'), (',', 'PUNCT'), ('Güneydoğu', 'ADJ'), ('Avrupa', 'PROPN'), ('ve', 'CCONJ'), ('Batı', 'ADJ'), ("Asya'da", 'PROPN'), ('konuşulan', 'VERB'), (',', 'PUNCT'), ('Türk', 'ADJ'), ('dilleri', 'NOUN'), ('dil', 'NOUN'), ('ailesine', 'NOUN'), ('ait', 'ADP'), ('sondan', 'NOUN'), ('eklemeli', 'ADJ'), ('bir', 'DET'), ('dil', 'NOUN'), ('.', 'PUNCT'), ('[12]', 'PUNCT')],
        results_lemmatize = ['Türkçe', 'ya', 'da', 'Türk', 'dili', ',', 'güneydoğu', 'Avrupa', 've', 'batı', 'Asya', 'konuş', ',', 'Türk', 'dil', 'dil', 'aile', 'ait', 'son', 'eklemeli', 'bir', 'dil', '.', '[12]'],
        results_dependency_parse = [('Türkçe', 'konuşulan', 'nsubj', 11), ('ya', 'dili', 'cc', 3), ('da', 'ya', 'fixed', -1), ('Türk', 'dili', 'nmod:poss', 1), ('dili', 'Türkçe', 'conj', -4), (',', 'konuşulan', 'punct', 6), ('Güneydoğu', 'konuşulan', 'obl', 5), ('Avrupa', 'Güneydoğu', 'flat', -1), ('ve', 'Batı', 'cc', 1), ('Batı', 'Güneydoğu', 'conj', -3), ("Asya'da", 'Batı', 'flat', -1), ('konuşulan', 'dil', 'acl', 10), (',', 'konuşulan', 'punct', -1), ('Türk', 'dilleri', 'nmod:poss', 1), ('dilleri', 'dil', 'nsubj', 7), ('dil', 'ailesine', 'nmod:poss', 1), ('ailesine', 'eklemeli', 'obl', 3), ('ait', 'ailesine', 'case', -1), ('sondan', 'eklemeli', 'obl', 1), ('eklemeli', 'dil', 'amod', 2), ('bir', 'dil', 'det', 1), ('dil', 'dil', 'root', 0), ('.', 'dil', 'punct', -1), ('[12]', '[12]', 'root', 0)]
    )
