# ----------------------------------------------------------------------
# Wordless: Tests - NLP - Stanza - Romanian
...
def test_stanza_ron():
    test_stanza.wl_test_stanza(
        ...
        results_pos_tag = [('Limba', 'Ncfsry'), ('română', 'Afpfsrn'), ('este', 'Vaip3s'), ('o', 'Tifsr'), ('limbă', 'Ncfsrn'), ('indo-europeană', 'Afpfsrn'), ('din', 'Spsa'), ('grupul', 'Ncmsry'), ('italic', 'Afpms-n'), ('și', 'Crssp'), ('din', 'Spsa'), ('subgrupul', 'Ncmsry'), ('oriental', 'Afpms-n'), ('al', 'Tsms'), ('limbilor', 'Ncmpoy'), ('romanice', 'Afpfp-n'), ('.', 'PERIOD')],
        ...
        results_lemmatize = ['limbă', 'român', 'fi', 'un', 'limbă', 'indo-european', 'din', 'grup', 'italic', 'și', 'din', 'subgrup', 'oriental', 'al', 'limbă', 'romanic', '.'],
