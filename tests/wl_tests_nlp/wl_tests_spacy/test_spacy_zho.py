# ----------------------------------------------------------------------
# Wordless: Tests - NLP - spaCy - Chinese
...
def test_spacy_zho():
    ...
    test_spacy.wl_test_spacy(
        ...
        results_sentence_tokenize_lg = [],
        results_word_tokenize = results_word_tokenize,
        results_pos_tag = [('漢語', 'NN'), ('又', 'AD'), ('稱', 'VV'), ('中文', 'NN'), ('、', 'PU'), ('華語', 'NN'), ('[', 'PU'), ('6', 'CD'), (']', 'PU'), ('、', 'PU'), ('唐話[', 'NN'), ('7', 'CD'), (']', 'PU'), ('，', 'PU'), ('概指', 'VV'), ('由', 'P'), ('上古', 'JJ'), ('漢語', 'NN'), ('（', 'PU'), ('先', 'JJ'), ('秦雅言', 'NR'), ('）', 'PU'), ('發展', 'VV'), ('而', 'MSP'), ('來', 'VV'), ('、', 'PU'), ('書面', 'AD'), ('使用', 'VV'), ('漢字', 'NN'), ('的', 'DEC'), ('分析語', 'NN'), ('，', 'PU'), ('為漢', 'NR'), ('藏語', 'NN'), ('系', 'NN'), ('最', 'AD'), ('大', 'VA'), ('的', 'DEC'), ('一', 'CD'), ('支', 'M'), ('語族', 'NN'), ('。', 'PU')],
        results_pos_tag_universal = [('漢語', 'NOUN'), ('又', 'ADV'), ('稱', 'VERB'), ('中文', 'NOUN'), ('、', 'PUNCT'), ('華語', 'NOUN'), ('[', 'PUNCT'), ('6', 'NUM'), (']', 'PUNCT'), ('、', 'PUNCT'), ('唐話[', 'NOUN'), ('7', 'NUM'), (']', 'PUNCT'), ('，', 'PUNCT'), ('概指', 'VERB'), ('由', 'ADP'), ('上古', 'ADJ'), ('漢語', 'NOUN'), ('（', 'PUNCT'), ('先', 'ADJ'), ('秦雅言', 'PROPN'), ('）', 'PUNCT'), ('發展', 'VERB'), ('而', 'PART'), ('來', 'VERB'), ('、', 'PUNCT'), ('書面', 'ADV'), ('使用', 'VERB'), ('漢字', 'NOUN'), ('的', 'PART'), ('分析語', 'NOUN'), ('，', 'PUNCT'), ('為漢', 'PROPN'), ('藏語', 'NOUN'), ('系', 'NOUN'), ('最', 'ADV'), ('大', 'VERB'), ('的', 'PART'), ('一', 'NUM'), ('支', 'NUM'), ('語族', 'NOUN'), ('。', 'PUNCT')],
        results_lemmatize = results_word_tokenize,
        results_dependency_parse = [('漢語', '稱', 'nsubj', 2), ('又', '稱', 'advmod', 1), ('稱', '稱', 'ROOT', 0), ('中文', '華語', 'conj', 2), ('、', '華語', 'punct', 1), ('華語', '唐話[', 'conj', 5), ('[', '6', 'punct', 1), ('6', '華語', 'parataxis:prnmod', -2), (']', '6', 'punct', -1), ('、', '唐話[', 'punct', 1), ('唐話[', '稱', 'dobj', -8), ('7', '稱', 'dep', -9), (']', '7', 'mark:clf', -1), ('，', '稱', 'punct', -11), ('概指', '稱', 'conj', -12), ('由', '漢語', 'case', 2), ('上古', '漢語', 'amod', 1), ('漢語', '發展', 'nmod:prep', 5), ('（', '秦雅言', 'punct', 2), ('先', '秦雅言', 'amod', 1), ('秦雅言', '漢語', 'parataxis:prnmod', -3), ('）', '秦雅言', 'punct', -1), ('發展', '分析語', 'acl', 8), ('而', '發展', 'advmod:rcomp', -1), ('來', '發展', 'advmod:rcomp', -2), ('、', '發展', 'punct', -3), ('書面', '使用', 'advmod', 1), ('使用', '發展', 'conj', -5), ('漢字', '使用', 'dobj', -1), ('的', '發展', 'mark', -7), ('分析語', '概指', 'dobj', -16), ('，', '稱', 'punct', -29), ('為漢', '語族', 'cop', 8), ('藏語', '系', 'compound:nn', 1), ('系', '大', 'dep', 2), ('最', '大', 'advmod', 1), ('大', '語族', 'amod', 4), ('的', '大', 'mark', -1), ('一', '語族', 'nummod', 2), ('支', '一', 'mark:clf', -1), ('語族', '稱', 'conj', -38), ('。', '稱', 'punct', -39)]
    )
