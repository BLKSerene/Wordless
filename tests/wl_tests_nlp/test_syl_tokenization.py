...
def test_syl_tokenize(lang, syl_tokenizer):
    ...
    if lang == 'afr':
        ...
        if syl_tokenizer == 'nltk_legality':
            assert syls == [['En', 'glish'], ['is'], ['a'], ['West'], ['Ger', 'ma', 'nic'], ['lan', 'gu', 'a', 'ge'], ['in'], ['the'], ['In', 'do'], ['-'], ['E', 'u', 'rop', 'ean'], ['lan', 'gu', 'a', 'ge'], ['fa', 'mi', 'ly'], [','], ['with'], ['its'], ['earl', 'iest'], ['forms'], ['spo', 'ken'], ['by'], ['the'], ['in', 'ha', 'bi', 'tants'], ['of'], ['e', 'ar', 'ly'], ['me', 'di', 'e', 'val'], ['En', 'gland.[3][4][5'], [']']]
        elif syl_tokenizer == 'nltk_sonority_sequencing':
            assert syls == [['English'], ['is'], ['a'], ['West'], ['Ger', 'ma', 'nic'], ['lan', 'gua', 'ge'], ['in'], ['the'], ['Indo'], ['-'], ['Eu', 'ro', 'pean'], ['lan', 'gua', 'ge'], ['fa', 'mi', 'ly'], [','], ['with'], ['its'], ['ear', 'liest'], ['forms'], ['spo', 'ken'], ['by'], ['the'], ['in', 'ha', 'bi', 'tants'], ['of'], ['ear', 'ly'], ['me', 'die', 'val'], ['England.[3][4][5'], [']']]
        elif syl_tokenizer == 'pyphen_eng_gb':
            assert syls == [['Eng', 'lish'], ['is'], ['a'], ['West'], ['Ger', 'man', 'ic'], ['lan', 'guage'], ['in'], ['the'], ['Indo'], ['-'], ['European'], ['lan', 'guage'], ['fam', 'ily'], [','], ['with'], ['its'], ['earli', 'est'], ['forms'], ['spoken'], ['by'], ['the'], ['in', 'hab', 'it', 'ants'], ['of'], ['early'], ['me', 'di', 'ev', 'al'], ['Eng', 'land.[3][4][5'], [']']]
        elif syl_tokenizer == 'pyphen_eng_us':
            assert syls == [['Eng', 'lish'], ['is'], ['a'], ['West'], ['Ger', 'man', 'ic'], ['lan', 'guage'], ['in'], ['the'], ['In', 'do'], ['-'], ['Eu', 'ro', 'pean'], ['lan', 'guage'], ['fam', 'i', 'ly'], [','], ['with'], ['its'], ['ear', 'li', 'est'], ['forms'], ['spo', 'ken'], ['by'], ['the'], ['in', 'hab', 'i', 'tants'], ['of'], ['ear', 'ly'], ['me', 'dieval'], ['Eng', 'land.[3][4][5'], [']']]
        else:
        ...
        assert syls == [['Le'], ['fran', 'çais'], ['est'], ['par', 'lé'], [','], ['en'], ['2023'], [','], ['sur'], ['tous'], ['les'], ['conti', 'nents'], ['par'], ['en', 'vi', 'ron'], ['321'], ['mil', 'lions'], ['de'], ['per', 'son', 'nes5,2'], [':'], ['235'], ['mil', 'lions'], ["l'"], ['em', 'ploient'], ['quo', 'ti', 'dien', 'ne', 'ment'], [','], ['et'], ['90'], ['mil', 'lions3'], ['en'], ['sont'], ['des'], ['lo', 'cu', 'teurs'], ['na', 'tifs'], ['.']]
    elif lang == 'glg':
        ...
        assert syls == [['È'], ['clas', 'si', 'fi', 'ca', 'to'], ['al'], ['23º'], ['po', 'sto'], ['tra'], ['le'], ['lin', 'gue'], ['per'], ['nu', 'me', 'ro'], ['di'], ['par', 'lan', 'ti'], ['nel'], ['mon', 'do'], ['e'], [','], ['in'], ['Ita', 'lia'], [','], ['è'], ['uti', 'liz', 'za', 'to'], ['da'], ['cir', 'ca'], ['58'], ['mi', 'lio', 'ni'], ['di'], ['re', 'si', 'den', 'ti.[2'], [']']]
    elif lang == 'lit':
