...
def test_sentence_tokenize(lang, sentence_tokenizer):
    ...
    if lang == 'cat':
        assert sentences == ["El català (denominació oficial a Catalunya, a les Illes Balears, a Andorra, a la ciutat de l'Alguer i tradicional a Catalunya del Nord) o valencià (denominació oficial al País Valencià i tradicional al Carxe) és una llengua romànica parlada a Catalunya, el País Valencià (tret d'algunes comarques i localitats de l'interior), les Illes Balears (on també rep el nom de mallorquí, menorquí, eivissenc o formenterer segons l'illa), Andorra, la Franja de Ponent (a l'Aragó), la ciutat de l'Alguer (a l'illa de Sardenya), la Catalunya del Nord,[8] el Carxe (un petit territori de Múrcia poblat per pobladors valencians),[9][10] i en comunitats arreu del món (entre les quals destaca la de l'Argentina, amb 200.000 parlants).[11] Té deu milions de parlants, dels quals quasi la meitat ho són de llengua materna; el seu domini lingüístic, amb una superfície de 68.730 km² i 13.529.127 d'habitants (2009),[12] inclou 1.687 termes municipals.", "Com a llengua materna, és parlada per quatre milions de persones (29% de la població del territori lingüístic), de les quals 2.263.000 a Catalunya,[13] 1.521.000 al País Valencià[14] i 417.000 a les Illes Balears.[15] Com les altres llengües romàniques, el català prové del llatí vulgar que parlaven els romans que s'establiren a Hispània durant l'edat antiga."]
    elif lang == 'zho_cn':
        assert sentences == ['汉语又称中文、华语[3]、唐话[4]，概指由上古汉语（先秦雅言）发展而来、书面使用汉字的分析语，为汉藏语系最大的一支语族。', '如把整个汉语族视为单一语言，则汉语为世界使用人数最多的语言，目前全世界有五分之一人口将汉语做为母语或第二语言。']
    elif lang == 'zho_tw':
        assert sentences == ['漢語又稱中文、華語[3]、唐話[4]，概指由上古漢語（先秦雅言）', '發展而來、書面使用漢字的分析語，為漢藏語系最大的一支語族。', '如把整個漢語族視為單一語言，則漢語為世界使用人數最多的語言，目前全世界有五分之一人口將漢語做為母語或第二語言。']
    elif lang == 'hrv':
        if sentence_tokenizer == 'spacy_dependency_parser_hrv':
            assert sentences == ['Hrvatski jezik (ISO 639-3: hrv) skupni je naziv za nacionalni standardni jezik Hrvata, te za skup narječja i govora kojima govore ili su nekada govorili Hrvati.', 'Njime govori više od 5,5 milijuna ljudi[2], poglavito Hrvata u Hrvatskoj (3 980 000; popis iz 2001.) i Bosni i Hercegovini (469 000; 2004.).[3] Hrvatski je materinski jezik za Hrvate u drugim zemljama; Sjedinjenim Američkim Državama (58 400; popis iz 2000.);[1] Austriji, 19 400 (popis iz 2001.); Srbiji 19 223 popis 2011. \u2002Inačica izvorne stranice\u2002arhivirana 4. ožujka 2022.; Mađarskoj, (14 300; popis iz 2001.); Italiji (3500; Vincent 1987.); Crnoj Gori (6810; 2006.); Slovačkoj, 890; popis iz 2001.).']
        elif sentence_tokenizer == 'spacy_sentence_recognizer_hrv':
            assert sentences == ['Hrvatski jezik (ISO 639-3: hrv) skupni je naziv za nacionalni standardni jezik Hrvata, te za skup narječja i govora kojima govore ili su nekada govorili Hrvati.', 'Njime govori više od 5,5 milijuna ljudi[2], poglavito Hrvata u Hrvatskoj (3 980 000; popis iz 2001.) i Bosni i Hercegovini (469 000; 2004.).[3] Hrvatski je materinski jezik za Hrvate u drugim zemljama; Sjedinjenim Američkim Državama (58 400; popis iz 2000.);[1] Austriji, 19 400 (popis iz 2001.); Srbiji 19 223 popis 2011.', 'Inačica izvorne stranice\u2002arhivirana 4. ožujka 2022.; Mađarskoj, (14 300; popis iz 2001.); Italiji (3500; Vincent 1987.); Crnoj Gori (6810; 2006.); Slovačkoj, 890; popis iz 2001.).']
        else:
        ...
        elif sentence_tokenizer == 'spacy_dependency_parser_dan':
            assert sentences == ['Dansk er et østnordisk sprog indenfor den germanske gren af den indoeuropæiske sprogfamilie.', 'Det danske sprog tales af ca. seks millioner mennesker, hovedsageligt i Danmark, men også i Sydslesvig (i Flensborg ca. 20 %), på Færøerne og Grønland.[1]', 'Dansk er tæt beslægtet med norsk, svensk og islandsk, og sproghistorisk har dansk været stærkt påvirket af plattysk.']
        elif sentence_tokenizer == 'spacy_sentence_recognizer_dan':
            assert sentences == ['Dansk er et østnordisk sprog indenfor den germanske gren af den indoeuropæiske sprogfamilie.', 'Det danske sprog tales af ca. seks millioner mennesker, hovedsageligt i Danmark, men også i Sydslesvig (i Flensborg ca. 20 %), på Færøerne og Grønland.[1] Dansk er tæt beslægtet med norsk, svensk og islandsk, og sproghistorisk har dansk været stærkt påvirket af plattysk.']
        else:
            tests_lang_util_skipped = True
    elif lang == 'nld':
        ...
        if sentence_tokenizer == 'nltk_punkt_ell':
        ...
        elif sentence_tokenizer == 'spacy_sentence_recognizer_lit':
            assert sentences == ['Lietuvių kalba – iš baltų prokalbės kilusi lietuvių tautos kalba, kuri Lietuvoje yra valstybinė, o Europos Sąjungoje – viena iš oficialiųjų kalbų.', 'Lietuviškai kalba apie tris milijonus žmonių (dauguma jų gyvena Lietuvoje).', 'Drauge su latvių, mirusiomis prūsų, jotvingių ir kitomis baltų kalbomis priklauso indoeuropiečių kalbų šeimos baltų kalbų grupei.']
        else:
            tests_lang_util_skipped = True
    elif lang == 'mkd':
        if sentence_tokenizer == 'spacy_dependency_parser_mkd':
        ...
        elif sentence_tokenizer == 'spacy_sentence_recognizer_mkd':
            assert sentences == ['Македонски јазик — јужнословенски јазик, дел од групата на словенски јазици од јазичното семејство на индоевропски јазици.', 'Македонскиот е службен и национален јазик во Македонија, а воедно е и официјално признат како регионален службен јазик во Горица и Пустец во Албанија каде што живее бројно македонско население, но и во Србија како официјален во општините Јабука и Пландиште, Романија и Косово.', 'Македонски се зборува', 'и во Австралија, Бугарија, Грција, Канада, САД, Црна Гора, Турција, во некои земји−членки на Европската Унија и останатата македонска дијаспора.', 'Вкупниот број на македонски говорници е тешко да се утврди поради несоодветни пописи, но бројката се движи од околу 2,5 до 3 милиони луѓе.']
        else:
            tests_lang_util_skipped = True
    elif lang == 'mal':
        ...
        elif sentence_tokenizer == 'spacy_dependency_parser_nob':
            assert sentences == ['Bokmål er en varietet av norsk skriftspråk.', 'Bokmål er en av to offisielle målformer av norsk skriftspråk, hvorav den andre er nynorsk.', 'I skrift har 87,3% bokmål som hovedmål i skolen.[1', '] Etter skriftreformene av riksmål i 1987 og bokmål i 1981 og 2005 er det lite som skiller bokmål og riksmål i alminnelig bruk.']
        elif sentence_tokenizer == 'spacy_sentence_recognizer_nob':
            assert sentences == ['Bokmål er en varietet av norsk skriftspråk.', 'Bokmål er en av to offisielle målformer av norsk skriftspråk, hvorav den andre er nynorsk.', 'I skrift har 87,3% bokmål som hovedmål i skolen.[1]', 'Etter skriftreformene av riksmål i 1987 og bokmål i 1981 og 2005 er det lite som skiller bokmål og riksmål i alminnelig bruk.']
        else:
            tests_lang_util_skipped = True
    elif lang == 'nno':
        ...
        if sentence_tokenizer == 'nltk_punkt_por':
            assert sentences == ['A língua portuguesa, também designada português, é uma língua indo-europeia românica flexiva ocidental originada no galego-português falado no Reino da Galiza e no norte de Portugal.', 'Com a criação do Reino de Portugal em 1139 e a expansão para o sul na sequência da Reconquista, deu-se a difusão da língua pelas terras conquistadas e mais tarde, com as descobertas portuguesas, para o Brasil, África e outras partes do mundo.', '[6] O português foi usado, naquela época, não somente nas cidades conquistadas pelos portugueses, mas também por muitos governantes locais nos seus contatos com outros estrangeiros poderosos.', 'Especialmente nessa altura a língua portuguesa também influenciou várias línguas.', '[7]']
        elif sentence_tokenizer in [
        ...
        if sentence_tokenizer == 'spacy_dependency_parser_ron':
            assert sentences == ['Limba română este o limbă indo-europeană din grupul italic și din subgrupul oriental al limbilor romanice.', 'Printre limbile romanice, româna este a cincea', 'după numărul de vorbitori, în urma spaniolei, portughezei, francezei și italienei', '.', 'Din motive de diferențiere tipologică, româna mai este numită în lingvistica comparată limba dacoromână sau dialectul dacoromân.', 'De asemenea, este înregistrată ca limbă de stat atât în România, cât și în Republica Moldova, unde circa 75% din populație o consideră limbă maternă (inclusiv sub denumirea de „limba moldovenească”).']
        elif sentence_tokenizer == 'spacy_sentence_recognizer_ron':
            assert sentences == ['Limba română este o limbă indo-europeană din grupul italic și din subgrupul oriental al limbilor romanice.', 'Printre limbile romanice, româna este a cincea după numărul de vorbitori, în urma spaniolei, portughezei, francezei și italienei.', 'Din motive de diferențiere tipologică, româna mai este numită în lingvistica comparată limba dacoromână sau dialectul dacoromân.', 'De asemenea, este înregistrată ca limbă de stat atât în România, cât și în Republica Moldova, unde circa 75% din populație o consideră limbă maternă (inclusiv sub denumirea de „limba moldovenească”).']
        else:
            tests_lang_util_skipped = True
    elif lang == 'rus':
        ...
        if sentence_tokenizer == 'spacy_dependency_parser_ukr':
        ...
        elif sentence_tokenizer == 'spacy_sentence_recognizer_ukr':
            assert sentences == ['Украї́нська мо́ва (МФА: [ukrɑ̽ˈjɪnʲsʲkɑ̽ ˈmɔwɑ̽], історичні назви — ру́ська, руси́нська[10][11][12][* 1]) — національна мова українців.', "Належить до східнослов'янської групи слов'янських мов, що входять до індоєвропейської мовної сім'ї, поряд з романськими, германськими, кельтськими, грецькою, албанською, вірменською та найближче спорідненими зі слов'янськими балтійськими мовами[13][14][* 2].", 'Є державною мовою в Україні[13][15].']
        else:
            tests_lang_util_skipped = True
    elif lang == 'vie':
...
def test_sentence_seg_tokenize(lang):
    ...
    if lang == 'cat':
        assert sentence_segs == ['El català (denominació oficial a Catalunya,', 'a les Illes Balears,', 'a Andorra,', "a la ciutat de l'Alguer i tradicional a Catalunya del Nord) o valencià (denominació oficial al País Valencià i tradicional al Carxe) és una llengua romànica parlada a Catalunya,", "el País Valencià (tret d'algunes comarques i localitats de l'interior),", 'les Illes Balears (on també rep el nom de mallorquí,', 'menorquí,', "eivissenc o formenterer segons l'illa),", 'Andorra,', "la Franja de Ponent (a l'Aragó),", "la ciutat de l'Alguer (a l'illa de Sardenya),", 'la Catalunya del Nord,', '[8] el Carxe (un petit territori de Múrcia poblat per pobladors valencians),', "[9][10] i en comunitats arreu del món (entre les quals destaca la de l'Argentina,", 'amb 200.', '000 parlants).', '[11] Té deu milions de parlants,', 'dels quals quasi la meitat ho són de llengua materna;', 'el seu domini lingüístic,', 'amb una superfície de 68.', '730 km² i 13.', '529.', "127 d'habitants (2009),", '[12] inclou 1.', '687 termes municipals.', 'Com a llengua materna,', 'és parlada per quatre milions de persones (29% de la població del territori lingüístic),', 'de les quals 2.', '263.', '000 a Catalunya,', '[13] 1.', '521.', '000 al País Valencià[14] i 417.', '000 a les Illes Balears.', '[15] Com les altres llengües romàniques,', "el català prové del llatí vulgar que parlaven els romans que s'establiren a Hispània durant l'edat antiga."]
    elif lang == 'zho_cn':
        assert sentence_segs == ['汉语又称中文、', '华语[3]、', '唐话[4]，', '概指由上古汉语（先秦雅言）发展而来、', '书面使用汉字的分析语，', '为汉藏语系最大的一支语族。', '如把整个汉语族视为单一语言，', '则汉语为世界使用人数最多的语言，', '目前全世界有五分之一人口将汉语做为母语或第二语言。']
    elif lang == 'zho_tw':
        assert sentence_segs == ['漢語又稱中文、', '華語[3]、', '唐話[4]，', '概指由上古漢語（先秦雅言）發展而來、', '書面使用漢字的分析語，', '為漢藏語系最大的一支語族。', '如把整個漢語族視為單一語言，', '則漢語為世界使用人數最多的語言，', '目前全世界有五分之一人口將漢語做為母語或第二語言。']
    elif lang == 'hrv':
        ...
        assert sentence_segs == ['English is a West Germanic language in the Indo-European language family,', 'with its earliest forms spoken by the inhabitants of early medieval England.', '[3][4][5] It is named after the Angles,', 'one of the ancient Germanic peoples that migrated to the island of Great Britain.', 'Existing on a dialect continuum with Scots,', 'and then most closely related to the Low German and Frisian languages,', 'English is genealogically Germanic.', 'However,', 'its vocabulary also shows major influences from French (about 28% of Modern English words) and Latin (also about 28%),', '[6] plus some grammar and a small amount of core vocabulary influenced by Old Norse (a North Germanic language).', '[7][8][9] Speakers of English are called Anglophones.']
    elif lang == 'est':
        ...
        assert sentence_segs == ['Le français est parlé,', 'en 2023,', 'sur tous les continents par environ 321 millions de personnes5,', '2 :', "235 millions l'emploient quotidiennement,", 'et 90 millions3 en sont des locuteurs natifs.', 'En 2018,', "80 millions d'élèves et étudiants s'instruisent en français dans le monde6.", "Selon l'Organisation internationale de la francophonie (OIF),", 'il pourrait y avoir 700 millions de francophones sur Terre en 20507.']
    elif lang.startswith('deu_'):
        ...
        assert sentence_segs == ['Украї́нська мо́ва (МФА:', '[ukrɑ̽ˈjɪnʲsʲkɑ̽ ˈmɔwɑ̽],', 'історичні назви — ру́ська,', 'руси́нська[10][11][12][* 1]) — національна мова українців.', "Належить до східнослов'янської групи слов'янських мов,", "що входять до індоєвропейської мовної сім'ї,", 'поряд з романськими,', 'германськими,', 'кельтськими,', 'грецькою,', 'албанською,', "вірменською та найближче спорідненими зі слов'янськими балтійськими мовами[13][14][* 2].", 'Є державною мовою в Україні[13][15].']
    elif lang == 'vie':
