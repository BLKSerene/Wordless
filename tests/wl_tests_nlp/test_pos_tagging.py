...
def test_pos_tag(lang, pos_tagger):
    ...
    if lang == 'cat':
        ...
        if pos_tagger == 'jieba_zho':
            ...
            assert tokens_tagged == [('汉语', 'NN'), ('又', 'AD'), ('称', 'VV'), ('华语', 'NN'), ('[3', 'CD'), (']', 'NN'), ('、', 'PU'), ('唐话', 'NR'), ('[', 'NR'), ('4', 'CD'), (']', 'M'), ('，', 'PU'), ('概指', 'VV'), ('由', 'P'), ('上古', 'NT'), ('汉语', 'NN'), ('（', 'PU'), ('先', 'AD'), ('秦雅言', 'NR'), ('）', 'PU'), ('发展', 'VV'), ('而', 'MSP'), ('来', 'VV'), ('、', 'PU'), ('书面', 'AD'), ('使用', 'VV'), ('汉字', 'NN'), ('的', 'DEG'), ('分析语', 'NN'), ('，', 'PU'), ('为', 'P'), ('汉藏', 'NR'), ('语系', 'NN'), ('最', 'AD'), ('大', 'VA'), ('的', 'DEC'), ('一', 'CD'), ('支', 'M'), ('语族', 'NN'), ('。', 'PU')]
            assert tokens_tagged_universal == [('汉语', 'NOUN'), ('又', 'ADV'), ('称', 'VERB'), ('华语', 'NOUN'), ('[3', 'NUM'), (']', 'NOUN'), ('、', 'PUNCT'), ('唐话', 'PROPN'), ('[', 'PROPN'), ('4', 'NUM'), (']', 'NUM'), ('，', 'PUNCT'), ('概指', 'VERB'), ('由', 'ADP'), ('上古', 'NOUN'), ('汉语', 'NOUN'), ('（', 'PUNCT'), ('先', 'ADV'), ('秦雅言', 'PROPN'), ('）', 'PUNCT'), ('发展', 'VERB'), ('而', 'PART'), ('来', 'VERB'), ('、', 'PUNCT'), ('书面', 'ADV'), ('使用', 'VERB'), ('汉字', 'NOUN'), ('的', 'PART'), ('分析语', 'NOUN'), ('，', 'PUNCT'), ('为', 'ADP'), ('汉藏', 'PROPN'), ('语系', 'NOUN'), ('最', 'ADV'), ('大', 'VERB'), ('的', 'PART'), ('一', 'NUM'), ('支', 'NUM'), ('语族', 'NOUN'), ('。', 'PUNCT')]
        else:
        ...
        if pos_tagger == 'jieba_zho':
            ...
            assert tokens_tagged == [('漢語', 'NN'), ('又', 'AD'), ('稱華', 'VV'), ('語[', 'NN'), ('3', 'CD'), (']', 'M'), ('、', 'PU'), ('唐話[', 'NR'), ('4', 'CD'), (']', 'M'), ('，', 'PU'), ('概指', 'VV'), ('由', 'P'), ('上古', 'NT'), ('漢語', 'VV'), ('（', 'PU'), ('先', 'AD'), ('秦雅言', 'NR'), ('）', 'PU'), ('發展', 'VV'), ('而', 'MSP'), ('來', 'VV'), ('、', 'PU'), ('書面', 'VV'), ('使用', 'NN'), ('漢字', 'NN'), ('的', 'DEC'), ('分析語', 'NN'), ('，', 'PU'), ('為漢', 'VV'), ('藏語', 'VV'), ('系', 'NN'), ('最', 'AD'), ('大', 'VA'), ('的', 'DEC'), ('一', 'CD'), ('支', 'M'), ('語族', 'NN'), ('。', 'PU')]
            assert tokens_tagged_universal == [('漢語', 'NOUN'), ('又', 'ADV'), ('稱華', 'VERB'), ('語[', 'NOUN'), ('3', 'NUM'), (']', 'NUM'), ('、', 'PUNCT'), ('唐話[', 'PROPN'), ('4', 'NUM'), (']', 'NUM'), ('，', 'PUNCT'), ('概指', 'VERB'), ('由', 'ADP'), ('上古', 'NOUN'), ('漢語', 'VERB'), ('（', 'PUNCT'), ('先', 'ADV'), ('秦雅言', 'PROPN'), ('）', 'PUNCT'), ('發展', 'VERB'), ('而', 'PART'), ('來', 'VERB'), ('、', 'PUNCT'), ('書面', 'VERB'), ('使用', 'NOUN'), ('漢字', 'NOUN'), ('的', 'PART'), ('分析語', 'NOUN'), ('，', 'PUNCT'), ('為漢', 'VERB'), ('藏語', 'VERB'), ('系', 'NOUN'), ('最', 'ADV'), ('大', 'VERB'), ('的', 'PART'), ('一', 'NUM'), ('支', 'NUM'), ('語族', 'NOUN'), ('。', 'PUNCT')]
        else:
            raise Exception(f'Error: Tests for POS tagger "{pos_tagger}" is skipped!')
    elif lang == 'dan':
        assert tokens_tagged == [('Dansk', 'ADJ'), ('er', 'AUX'), ('et', 'DET'), ('østnordisk', 'ADJ'), ('sprog', 'NOUN'), ('indenfor', 'ADP'), ('den', 'DET'), ('germanske', 'ADJ'), ('gren', 'NOUN'), ('af', 'ADP'), ('den', 'DET'), ('indoeuropæiske', 'ADJ'), ('sprogfamilie', 'NOUN'), ('.', 'PUNCT')]
        assert tokens_tagged_universal == [('Dansk', 'ADJ'), ('er', 'AUX'), ('et', 'DET'), ('østnordisk', 'ADJ'), ('sprog', 'NOUN'), ('indenfor', 'ADP'), ('den', 'DET'), ('germanske', 'ADJ'), ('gren', 'NOUN'), ('af', 'ADP'), ('den', 'DET'), ('indoeuropæiske', 'ADJ'), ('sprogfamilie', 'NOUN'), ('.', 'PUNCT')]
    elif lang == 'nld':
        ...
        assert tokens_tagged == tokens_tagged_universal == [('Le', 'DET'), ('français', 'NOUN'), ('est', 'AUX'), ('une', 'DET'), ('langue', 'NOUN'), ('indo-européenne', 'ADJ'), ('de', 'ADP'), ('la', 'DET'), ('famille', 'NOUN'), ('des', 'ADP'), ('langues', 'ADJ'), ('romanes', 'ADJ'), ('dont', 'PRON'), ('les', 'DET'), ('locuteurs', 'NOUN'), ('sont', 'AUX'), ('appelés', 'VERB'), ('francophones', 'ADJ'), (',', 'PUNCT'), ('également', 'ADV'), ('surnommé', 'VERB'), ('la', 'DET'), ('langue', 'NOUN'), ('de', 'ADP'), ('Molière', 'PROPN'), ('.', 'PUNCT')]
    elif lang.startswith('deu_'):
        assert tokens_tagged == [('Die', 'ART'), ('deutsche', 'ADJA'), ('Sprache', 'NN'), ('bzw.', 'KON'), ('Deutsch', 'NN'), ('(', '$('), ('[', 'NE'), ('dɔɪ̯tʃ];[26', 'NE'), (']', 'NN'), ('abgekürzt', 'VVFIN'), ('dt', 'NE'), ('.', '$.'), ('oder', 'KON'), ('dtsch', 'ADJD'), ('.', '$.'), (')', '$('), ('ist', 'VAFIN'), ('eine', 'ART'), ('westgermanische', 'ADJA'), ('Sprache', 'NN'), (',', '$,'), ('die', 'PRELS'), ('weltweit', 'ADJD'), ('etwa', 'ADV'), ('90', 'CARD'), ('bis', 'KON'), ('105', 'CARD'), ('Millionen', 'NN'), ('Menschen', 'NN'), ('als', 'APPR'), ('Muttersprache', 'NN'), ('und', 'KON'), ('weiteren', 'ADJA'), ('rund', 'ADV'), ('80', 'CARD'), ('Millionen', 'NN'), ('als', 'APPR'), ('Zweit-', 'TRUNC'), ('oder', 'KON'), ('Fremdsprache', 'NN'), ('dient', 'VVFIN'), ('.', '$.')]
        assert tokens_tagged_universal == [('Die', 'DET'), ('deutsche', 'ADJ'), ('Sprache', 'NOUN'), ('bzw.', 'CCONJ'), ('Deutsch', 'NOUN'), ('(', 'PUNCT'), ('[', 'NOUN'), ('dɔɪ̯tʃ];[26', 'PROPN'), (']', 'NOUN'), ('abgekürzt', 'VERB'), ('dt', 'PROPN'), ('.', 'PUNCT'), ('oder', 'CCONJ'), ('dtsch', 'ADV'), ('.', 'PUNCT'), (')', 'PUNCT'), ('ist', 'AUX'), ('eine', 'DET'), ('westgermanische', 'ADJ'), ('Sprache', 'NOUN'), (',', 'PUNCT'), ('die', 'PRON'), ('weltweit', 'ADV'), ('etwa', 'ADV'), ('90', 'NUM'), ('bis', 'CCONJ'), ('105', 'NUM'), ('Millionen', 'NOUN'), ('Menschen', 'NOUN'), ('als', 'ADP'), ('Muttersprache', 'NOUN'), ('und', 'CCONJ'), ('weiteren', 'ADJ'), ('rund', 'ADV'), ('80', 'NUM'), ('Millionen', 'NOUN'), ('als', 'ADP'), ('Zweit-', 'X'), ('oder', 'CCONJ'), ('Fremdsprache', 'NOUN'), ('dient', 'VERB'), ('.', 'PUNCT')]
    elif lang == 'ell':
        ...
        assert tokens_tagged == tokens_tagged_universal == [('A', 'DET'), ('língua', 'NOUN'), ('portuguesa', 'ADJ'), (',', 'PUNCT'), ('também', 'ADV'), ('designada', 'VERB'), ('português', 'ADJ'), (',', 'PUNCT'), ('é', 'AUX'), ('uma', 'DET'), ('língua', 'NOUN'), ('indo-europeia', 'NOUN'), ('românica', 'ADJ'), ('flexiva', 'ADJ'), ('ocidental', 'ADJ'), ('originada', 'VERB'), ('no', 'ADP'), ('galego-português', 'NOUN'), ('falado', 'VERB'), ('no', 'ADP'), ('Reino', 'PROPN'), ('da', 'ADP'), ('Galiza', 'PROPN'), ('e', 'CCONJ'), ('no', 'ADP'), ('norte', 'NOUN'), ('de', 'ADP'), ('Portugal', 'PROPN'), ('.', 'PUNCT')]
    elif lang == 'ron':
