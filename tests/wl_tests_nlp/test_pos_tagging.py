...
def test_pos_tag(lang, pos_tagger):
    ...
    if lang == 'cat':
        ...
        if pos_tagger == 'spacy_jpn':
            ...
            assert tokens_tagged_universal == [('日本語', 'NOUN'), ('（', 'PUNCT'), ('にほん', 'NOUN'), ('ご', 'PART'), ('、', 'PUNCT'), ('にっぽん', 'NOUN'), ('ご', 'PART'), ('[', 'PUNCT'), ('注', 'NOUN'), ('2', 'NOUN'), (']', 'PUNCT'), ('）', 'PUNCT'), ('は', 'PART'), ('、', 'PUNCT'), ('日本', 'NOUN'), ('国', 'PART'), ('内', 'PART'), ('や', 'PART'), ('、', 'PUNCT'), ('かつて', 'ADV'), ('の', 'PART'), ('日本', 'NOUN'), ('領', 'PART'), ('だっ', 'AUX'), ('た', 'AUX'), ('国', 'NOUN'), ('、', 'PUNCT'), ('そして', 'CONJ'), ('国外', 'NOUN'), ('移民', 'NOUN'), ('や', 'PART'), ('移住者', 'NOUN'), ('を', 'PART'), ('含む', 'VERB'), ('日本人', 'NOUN'), ('同士', 'PART'), ('の', 'PART'), ('間', 'NOUN'), ('で', 'PART'), ('使用', 'NOUN'), ('さ', 'VERB'), ('れ', 'AUX'), ('て', 'PART'), ('いる', 'VERB'), ('言語', 'NOUN'), ('。', 'PUNCT')]
        else:
            tests_lang_util_skipped = True
    elif lang == 'lit':
