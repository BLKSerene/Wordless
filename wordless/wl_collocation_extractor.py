# ----------------------------------------------------------------------
# Wordless: Work Area - Collocation Extractor
...
class Wrapper_Collocation_Extractor(wl_layouts.Wl_Wrapper):
    def __init__(self, main):
        ...
        layout_results.addWidget(self.table_collocation_extractor.label_num_results, 0, 0)
        layout_results.addWidget(self.table_collocation_extractor.button_results_sample, 0, 2)
        layout_results.addWidget(self.table_collocation_extractor.button_results_filter, 0, 3)
        layout_results.addWidget(self.table_collocation_extractor.button_results_search, 0, 4)
        ...
        self.wrapper_table.layout().addWidget(self.table_collocation_extractor.button_exp_selected_cells, 2, 2)
        self.wrapper_table.layout().addWidget(self.table_collocation_extractor.button_exp_all_cells, 2, 3)
        self.wrapper_table.layout().addWidget(self.table_collocation_extractor.button_clr_table, 2, 4)
        ...
        self.group_box_table_settings.layout().addWidget(self.checkbox_show_total, 4, 0)
...
class Wl_Table_Collocation_Extractor(wl_tables.Wl_Table_Data):
    ...
    def run(self):
        try:
            ...
            for i, file in enumerate(files):
                ...
                tokens = wl_nlp_utils.add_missing_ending_tshegs(self.main, tokens, tab = 'collocation_extractor')
