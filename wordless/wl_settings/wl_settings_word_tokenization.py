...
class Wl_Settings_Word_Tokenization(wl_settings.Wl_Settings_Node):
    def __init__(self, main):
        ...
        self.group_box_word_tokenizer_settings = QtWidgets.QGroupBox(self.tr('Word Tokenizer Settings'), self)
        ...
        for i, lang in enumerate(self.settings_global):
            self.table_word_tokenizers.model().setItem(i, 0, QtGui.QStandardItem(wl_conversion.to_lang_text(self.main, lang)))
            self.table_word_tokenizers.model().setItem(i, 1, QtGui.QStandardItem())
