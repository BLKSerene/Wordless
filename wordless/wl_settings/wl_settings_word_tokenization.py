...
class Wl_Settings_Word_Tokenization(wl_settings.Wl_Settings_Node):
    def __init__(self, main):
        ...
        self.button_word_tokenization_show_preview.setMinimumWidth(140)
        ...
        self.group_box_preview.layout().addWidget(self.text_edit_word_tokenization_preview_samples, 1, 0)
        self.group_box_preview.layout().addWidget(self.text_edit_word_tokenization_preview_results, 1, 1)
    ...
    def load_settings(self, defaults = False):
        ...
        if not defaults:
            ...
            self.combo_box_word_tokenization_preview_lang.setCurrentText(wl_conversion.to_lang_text(self.main, settings['preview']['preview_lang']))
            self.text_edit_word_tokenization_preview_samples.setText(settings['preview']['preview_samples'])
            self.text_edit_word_tokenization_preview_results.setText(settings['preview']['preview_results'])
