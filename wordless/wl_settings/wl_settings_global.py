    ...
    SETTINGS_GLOBAL = {
        ...
        'mapping_lang_utils': {
            ...
            'word_tokenizers': {
                ...
                _tr('wl_settings_global', 'Stanza - German (Low) word tokenizer'): 'stanza_nds',
            ...
            'syl_tokenizers': {
                ...
                _tr('wl_settings_global', 'Pyphen - Assamese syllable tokenizer'): 'pyphen_asm',
                ...
                _tr('wl_settings_global', 'Pyphen - Kannada syllable tokenizer'): 'pyphen_kan',
                ...
                _tr('wl_settings_global', 'Pyphen - Marathi syllable tokenizer'): 'pyphen_mar',
                _tr('wl_settings_global', 'Pyphen - Mongolian (Cyrillic script) syllable tokenizer'): 'pyphen_mon_cyrl',
                ...
                _tr('wl_settings_global', 'Pyphen - Oriya syllable tokenizer'): 'pyphen_ori',
                _tr('wl_settings_global', 'Pyphen - Panjabi (Gurmukhi script) syllable tokenizer'): 'pyphen_pan_guru',
                ...
                _tr('wl_settings_global', 'Pyphen - Sanskrit syllable tokenizer'): 'pyphen_san',
            ...
            'pos_taggers': {
                ...
                _tr('wl_settings_global', 'Stanza - German (Low) part-of-speech tagger'): 'stanza_nds',
            ...
            'stop_word_lists': {
                ...
                _tr('wl_settings_global', 'spaCy - Afrikaans stop word list'): 'spacy_afr',
                _tr('wl_settings_global', 'spaCy - Albanian stop word list'): 'spacy_sqi',
                _tr('wl_settings_global', 'spaCy - Amharic stop word list'): 'spacy_amh',
                _tr('wl_settings_global', 'spaCy - Arabic stop word list'): 'spacy_ara',
                _tr('wl_settings_global', 'spaCy - Armenian stop word list'): 'spacy_hye',
                _tr('wl_settings_global', 'spaCy - Azerbaijani stop word list'): 'spacy_aze',
                _tr('wl_settings_global', 'spaCy - Basque stop word list'): 'spacy_eus',
                _tr('wl_settings_global', 'spaCy - Bengali stop word list'): 'spacy_ben',
                _tr('wl_settings_global', 'spaCy - Bulgarian stop word list'): 'spacy_bul',
                _tr('wl_settings_global', 'spaCy - Catalan stop word list'): 'spacy_cat',
                _tr('wl_settings_global', 'spaCy - Chinese (Simplified) stop word list'): 'spacy_zho_cn',
                _tr('wl_settings_global', 'spaCy - Croatian stop word list'): 'spacy_hrv',
                _tr('wl_settings_global', 'spaCy - Czech stop word list'): 'spacy_ces',
                _tr('wl_settings_global', 'spaCy - Danish stop word list'): 'spacy_dan',
                _tr('wl_settings_global', 'spaCy - Dutch stop word list'): 'spacy_nld',
                _tr('wl_settings_global', 'spaCy - English stop word list'): 'spacy_eng',
                _tr('wl_settings_global', 'spaCy - Estonian stop word list'): 'spacy_est',
                _tr('wl_settings_global', 'spaCy - Finnish stop word list'): 'spacy_fin',
                _tr('wl_settings_global', 'spaCy - French stop word list'): 'spacy_fra',
                _tr('wl_settings_global', 'spaCy - Ganda stop word list'): 'spacy_lug',
                _tr('wl_settings_global', 'spaCy - German stop word list'): 'spacy_deu',
                _tr('wl_settings_global', 'spaCy - Greek (Ancient) stop word list'): 'spacy_grc',
                _tr('wl_settings_global', 'spaCy - Greek (Modern) stop word list'): 'spacy_ell',
                _tr('wl_settings_global', 'spaCy - Gujarati stop word list'): 'spacy_guj',
                _tr('wl_settings_global', 'spaCy - Hebrew stop word list'): 'spacy_heb',
                _tr('wl_settings_global', 'spaCy - Hindi stop word list'): 'spacy_hin',
                _tr('wl_settings_global', 'spaCy - Hungarian stop word list'): 'spacy_hun',
                _tr('wl_settings_global', 'spaCy - Icelandic stop word list'): 'spacy_isl',
                _tr('wl_settings_global', 'spaCy - Indonesian stop word list'): 'spacy_ind',
                _tr('wl_settings_global', 'spaCy - Irish stop word list'): 'spacy_gle',
                _tr('wl_settings_global', 'spaCy - Italian stop word list'): 'spacy_ita',
                _tr('wl_settings_global', 'spaCy - Japanese stop word list'): 'spacy_jpn',
                _tr('wl_settings_global', 'spaCy - Kannada stop word list'): 'spacy_kan',
                _tr('wl_settings_global', 'spaCy - Korean stop word list'): 'spacy_kor',
                _tr('wl_settings_global', 'spaCy - Kurdish (Kurmanji) stop word list'): 'spacy_kmr',
                _tr('wl_settings_global', 'spaCy - Kyrgyz stop word list'): 'spacy_kir',
                _tr('wl_settings_global', 'spaCy - Latin stop word list'): 'spacy_lat',
                _tr('wl_settings_global', 'spaCy - Latvian stop word list'): 'spacy_lav',
                _tr('wl_settings_global', 'spaCy - Ligurian stop word list'): 'spacy_lij',
                _tr('wl_settings_global', 'spaCy - Lithuanian stop word list'): 'spacy_lit',
                _tr('wl_settings_global', 'spaCy - Luxembourgish stop word list'): 'spacy_ltz',
                _tr('wl_settings_global', 'spaCy - Macedonian stop word list'): 'spacy_mkd',
                _tr('wl_settings_global', 'spaCy - Malay stop word list'): 'spacy_msa',
                _tr('wl_settings_global', 'spaCy - Malayalam stop word list'): 'spacy_mal',
                _tr('wl_settings_global', 'spaCy - Marathi stop word list'): 'spacy_mar',
                _tr('wl_settings_global', 'spaCy - Nepali stop word list'): 'spacy_nep',
                _tr('wl_settings_global', 'spaCy - Norwegian (Bokmål) stop word list'): 'spacy_nob',
                _tr('wl_settings_global', 'spaCy - Persian stop word list'): 'spacy_fas',
                _tr('wl_settings_global', 'spaCy - Polish stop word list'): 'spacy_pol',
                _tr('wl_settings_global', 'spaCy - Portuguese stop word list'): 'spacy_por',
                _tr('wl_settings_global', 'spaCy - Romanian stop word list'): 'spacy_ron',
                _tr('wl_settings_global', 'spaCy - Russian stop word list'): 'spacy_rus',
                _tr('wl_settings_global', 'spaCy - Sanskrit stop word list'): 'spacy_san',
                _tr('wl_settings_global', 'spaCy - Scottish Gaelic stop word list'): 'spacy_gla',
                _tr('wl_settings_global', 'spaCy - Serbian (Cyrillic script) stop word list'): 'spacy_srp_cyrl',
                _tr('wl_settings_global', 'spaCy - Sinhala stop word list'): 'spacy_sin',
                _tr('wl_settings_global', 'spaCy - Slovak stop word list'): 'spacy_slk',
                _tr('wl_settings_global', 'spaCy - Slovenian stop word list'): 'spacy_slv',
                _tr('wl_settings_global', 'spaCy - Sorbian (Lower) stop word list'): 'spacy_dsb',
                _tr('wl_settings_global', 'spaCy - Sorbian (Upper) stop word list'): 'spacy_hsb',
                _tr('wl_settings_global', 'spaCy - Spanish stop word list'): 'spacy_spa',
                _tr('wl_settings_global', 'spaCy - Swedish stop word list'): 'spacy_swe',
                _tr('wl_settings_global', 'spaCy - Tagalog stop word list'): 'spacy_tgl',
                _tr('wl_settings_global', 'spaCy - Tamil stop word list'): 'spacy_tam',
                _tr('wl_settings_global', 'spaCy - Tatar stop word list'): 'spacy_tat',
                _tr('wl_settings_global', 'spaCy - Telugu stop word list'): 'spacy_tel',
                _tr('wl_settings_global', 'spaCy - Thai stop word list'): 'spacy_tha',
                _tr('wl_settings_global', 'spaCy - Tibetan stop word list'): 'spacy_bod',
                _tr('wl_settings_global', 'spaCy - Tigrinya stop word list'): 'spacy_tir',
                _tr('wl_settings_global', 'spaCy - Tswana stop word list'): 'spacy_tsn',
                _tr('wl_settings_global', 'spaCy - Turkish stop word list'): 'spacy_tur',
                _tr('wl_settings_global', 'spaCy - Ukrainian stop word list'): 'spacy_ukr',
                _tr('wl_settings_global', 'spaCy - Urdu stop word list'): 'spacy_urd',
                _tr('wl_settings_global', 'spaCy - Vietnamese stop word list'): 'spacy_vie',
                _tr('wl_settings_global', 'spaCy - Yoruba stop word list'): 'spacy_yor',
            ...
            'dependency_parsers': {
                ...
                _tr('wl_settings_global', 'Stanza - German (Low) dependency parser'): 'stanza_nds',
