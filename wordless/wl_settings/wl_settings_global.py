...
SETTINGS_GLOBAL = {
    ...
    'langs': {
        _tr('wl_settings_global', 'Afrikaans'): ['afr', 'af', 'Indo-European'],
        _tr('wl_settings_global', 'Akan'): ['aka', 'ak', 'Niger-Congo'],
        _tr('wl_settings_global', 'Albanian'): ['sqi', 'sq', 'Indo-European'],
        _tr('wl_settings_global', 'Amharic'): ['amh', 'am', 'Afro-Asiatic'],
        _tr('wl_settings_global', 'Arabic'): ['ara', 'ar', 'Afro-Asiatic'],
        _tr('wl_settings_global', 'Armenian (Eastern)'): ['hye', 'hy', 'Indo-European'],
        _tr('wl_settings_global', 'Armenian (Western)'): ['hyw', 'hyw', 'Indo-European'],
        _tr('wl_settings_global', 'Assamese'): ['asm', 'as', 'Indo-European'],
        _tr('wl_settings_global', 'Asturian'): ['ast', 'ast', 'Indo-European'],
        _tr('wl_settings_global', 'Aymara'): ['aym', 'ay', 'Aymaran'],
        _tr('wl_settings_global', 'Azerbaijani'): ['aze', 'az', 'Turkic'],
        _tr('wl_settings_global', 'Bambara'): ['bam', 'bm', 'Niger-Congo'],
        _tr('wl_settings_global', 'Basque'): ['eus', 'eu', 'Language isolate'],
        _tr('wl_settings_global', 'Belarusian'): ['bel', 'be', 'Indo-European'],
        _tr('wl_settings_global', 'Bengali'): ['ben', 'bn', 'Indo-European'],
        _tr('wl_settings_global', 'Bhojpuri'): ['bho', 'bho', 'Indo-European'],
        _tr('wl_settings_global', 'Bosnian'): ['bos', 'bs', 'Indo-European'],
        _tr('wl_settings_global', 'Bulgarian'): ['bul', 'bg', 'Indo-European'],
        _tr('wl_settings_global', 'Burmese'): ['mya', 'my', 'Sino-Tibetan'],
        _tr('wl_settings_global', 'Buryat (Russia)'): ['bxr', 'bxr', 'Mongolic'],
        _tr('wl_settings_global', 'Catalan'): ['cat', 'ca', 'Indo-European'],
        _tr('wl_settings_global', 'Cebuano'): ['ceb', 'ceb', 'Austronesian'],
        _tr('wl_settings_global', 'Chewa'): ['nya', 'ny', 'Niger-Congo'],
        _tr('wl_settings_global', 'Chinese (Classical)'): ['lzh', 'lzh', 'Sino-Tibetan'],
        _tr('wl_settings_global', 'Chinese (Simplified)'): ['zho_cn', 'zh_cn', 'Sino-Tibetan'],
        _tr('wl_settings_global', 'Chinese (Traditional)'): ['zho_tw', 'zh_tw', 'Sino-Tibetan'],
        _tr('wl_settings_global', 'Church Slavonic (Old)'): ['chu', 'cu', 'Indo-European'],
        _tr('wl_settings_global', 'Coptic'): ['cop', 'cop', 'Afro-Asiatic'],
        _tr('wl_settings_global', 'Corsican'): ['cos', 'co', 'Indo-European'],
        _tr('wl_settings_global', 'Croatian'): ['hrv', 'hr', 'Indo-European'],
        _tr('wl_settings_global', 'Czech'): ['ces', 'cs', 'Indo-European'],
        _tr('wl_settings_global', 'Danish'): ['dan', 'da', 'Indo-European'],
        _tr('wl_settings_global', 'Dogri (Devanagari script)'): ['doi_deva', 'doi_deva', 'Indo-European'],
        _tr('wl_settings_global', 'Dutch'): ['nld', 'nl', 'Indo-European'],
        _tr('wl_settings_global', 'English (Middle)'): ['enm', 'enm', 'Indo-European'],
        _tr('wl_settings_global', 'English (United Kingdom)'): ['eng_gb', 'en_gb', 'Indo-European'],
        _tr('wl_settings_global', 'English (United States)'): ['eng_us', 'en_us', 'Indo-European'],
        _tr('wl_settings_global', 'Erzya'): ['myv', 'myv', 'Uralic'],
        _tr('wl_settings_global', 'Esperanto'): ['epo', 'eo', 'Constructed'],
        _tr('wl_settings_global', 'Estonian'): ['est', 'et', 'Uralic'],
        _tr('wl_settings_global', 'Ewe'): ['ewe', 'ee', 'Niger-Congo'],
        _tr('wl_settings_global', 'Faroese'): ['fao', 'fo', 'Indo-European'],
        _tr('wl_settings_global', 'Finnish'): ['fin', 'fi', 'Uralic'],
        _tr('wl_settings_global', 'French'): ['fra', 'fr', 'Indo-European'],
        _tr('wl_settings_global', 'French (Old)'): ['fro', 'fro', 'Indo-European'],
        _tr('wl_settings_global', 'Frisian (West)'): ['fry', 'fy', 'Indo-European'],
        _tr('wl_settings_global', 'Galician'): ['glg', 'gl', 'Indo-European'],
        _tr('wl_settings_global', 'Georgian'): ['kat', 'ka', 'Kartvelian'],
        _tr('wl_settings_global', 'German (Austria)'): ['deu_at', 'de_at', 'Indo-European'],
        _tr('wl_settings_global', 'German (Germany)'): ['deu_de', 'de_de', 'Indo-European'],
        _tr('wl_settings_global', 'German (Switzerland)'): ['deu_ch', 'de_ch', 'Indo-European'],
        _tr('wl_settings_global', 'Gothic'): ['got', 'got', 'Indo-European'],
        _tr('wl_settings_global', 'Greek (Ancient)'): ['grc', 'grc', 'Unclassified'],
        _tr('wl_settings_global', 'Greek (Modern)'): ['ell', 'el', 'Indo-European'],
        _tr('wl_settings_global', 'Guarani'): ['grn', 'gn', 'Tupian'],
        _tr('wl_settings_global', 'Gujarati'): ['guj', 'gu', 'Indo-European'],
        _tr('wl_settings_global', 'Haitian Creole'): ['hat', 'ht', 'French Creole'],
        _tr('wl_settings_global', 'Hausa'): ['hau', 'ha', 'Afro-Asiatic'],
        _tr('wl_settings_global', 'Hawaiian'): ['haw', 'haw', 'Austronesian'],
        _tr('wl_settings_global', 'Hebrew (Ancient)'): ['hbo', 'hbo', 'Afro-Asiatic'],
        _tr('wl_settings_global', 'Hebrew (Modern)'): ['heb', 'he', 'Afro-Asiatic'],
        _tr('wl_settings_global', 'Hindi'): ['hin', 'hi', 'Indo-European'],
        _tr('wl_settings_global', 'Hmong (RPA script)'): ['hmn_rpa', 'hmn_rpa', 'Hmong–Mien'],
        _tr('wl_settings_global', 'Hungarian'): ['hun', 'hu', 'Uralic'],
        _tr('wl_settings_global', 'Icelandic'): ['isl', 'is', 'Indo-European'],
        _tr('wl_settings_global', 'Igbo'): ['ibo', 'ig', 'Niger-Congo'],
        _tr('wl_settings_global', 'Ilocano'): ['ilo', 'ilo', 'Austronesian'],
        _tr('wl_settings_global', 'Indonesian'): ['ind', 'id', 'Austronesian'],
        _tr('wl_settings_global', 'Irish'): ['gle', 'ga', 'Indo-European'],
        _tr('wl_settings_global', 'Italian'): ['ita', 'it', 'Indo-European'],
        _tr('wl_settings_global', 'Japanese'): ['jpn', 'ja', 'Japonic'],
        _tr('wl_settings_global', 'Javanese'): ['jav', 'jv', 'Austronesian'],
        _tr('wl_settings_global', 'Kannada'): ['kan', 'kn', 'Dravidian'],
        _tr('wl_settings_global', 'Kazakh'): ['kaz', 'kk', 'Turkic'],
        _tr('wl_settings_global', 'Khmer'): ['khm', 'km', 'Austroasiatic'],
        _tr('wl_settings_global', 'Kinyarwanda'): ['kin', 'rw', 'Niger-Congo'],
        _tr('wl_settings_global', 'Konkani (Goan) (Devanagari script)'): ['gom_deva', 'gom_deva', 'Indo-European'],
        _tr('wl_settings_global', 'Korean'): ['kor', 'ko', 'Koreanic'],
        _tr('wl_settings_global', 'Krio'): ['kri', 'kri', 'English Creole'],
        _tr('wl_settings_global', 'Kurdish (Kurmanji)'): ['kmr', 'kmr', 'Indo-European'],
        _tr('wl_settings_global', 'Kurdish (Sorani)'): ['ckb', 'ckb', 'Indo-European'],
        _tr('wl_settings_global', 'Kyrgyz'): ['kir', 'ky', 'Turkic'],
        _tr('wl_settings_global', 'Lao'): ['lao', 'lo', 'Kra-Dai'],
        _tr('wl_settings_global', 'Latin'): ['lat', 'la', 'Indo-European'],
        _tr('wl_settings_global', 'Latvian'): ['lav', 'lv', 'Indo-European'],
        _tr('wl_settings_global', 'Ligurian'): ['lij', 'lij', 'Unclassified'],
        _tr('wl_settings_global', 'Lingala'): ['lin', 'ln', 'Niger-Congo'],
        _tr('wl_settings_global', 'Lithuanian'): ['lit', 'lt', 'Indo-European'],
        _tr('wl_settings_global', 'Luganda'): ['lug', 'lg', 'Niger-Congo'],
        _tr('wl_settings_global', 'Luxembourgish'): ['ltz', 'lb', 'Indo-European'],
        _tr('wl_settings_global', 'Macedonian'): ['mkd', 'mk', 'Indo-European'],
        _tr('wl_settings_global', 'Maithili'): ['mai', 'mai', 'Indo-European'],
        _tr('wl_settings_global', 'Malagasy'): ['mlg', 'mg', 'Austronesian'],
        _tr('wl_settings_global', 'Malay'): ['msa', 'ms', 'Austronesian'],
        _tr('wl_settings_global', 'Malayalam'): ['mal', 'ml', 'Dravidian'],
        _tr('wl_settings_global', 'Maldivian'): ['div', 'dv', 'Indo-European'],
        _tr('wl_settings_global', 'Maltese'): ['mlt', 'mt', 'Afro-Asiatic'],
        _tr('wl_settings_global', 'Manx'): ['glv', 'gv', 'Indo-European'],
        _tr('wl_settings_global', 'Māori'): ['mri', 'mi', 'Austronesian'],
        _tr('wl_settings_global', 'Marathi'): ['mar', 'mr', 'Indo-European'],
        _tr('wl_settings_global', 'Meitei (Meitei script)'): ['mni_mtei', 'mni_mtei', 'Sino-Tibetan'],
        _tr('wl_settings_global', 'Mizo'): ['lus', 'lus', 'Sino-Tibetan'],
        _tr('wl_settings_global', 'Mongolian'): ['mon', 'mn', 'Mongolic'],
        _tr('wl_settings_global', 'Nepali'): ['nep', 'ne', 'Indo-European'],
        _tr('wl_settings_global', 'Nigerian Pidgin'): ['pcm', 'pcm', 'English Creole'],
        _tr('wl_settings_global', 'Norwegian (Bokmål)'): ['nob', 'nb', 'Indo-European'],
        _tr('wl_settings_global', 'Norwegian (Nynorsk)'): ['nno', 'nn', 'Indo-European'],
        _tr('wl_settings_global', 'Odia'): ['ori', 'or', 'Indo-European'],
        _tr('wl_settings_global', 'Oromo'): ['orm', 'om', 'Afro-Asiatic'],
        _tr('wl_settings_global', 'Pashto'): ['pus', 'ps', 'Indo-European'],
        _tr('wl_settings_global', 'Persian'): ['fas', 'fa', 'Indo-European'],
        _tr('wl_settings_global', 'Polish'): ['pol', 'pl', 'Indo-European'],
        _tr('wl_settings_global', 'Pomak'): ['qpm', 'qpm', 'Unclassified'],
        _tr('wl_settings_global', 'Portuguese (Brazil)'): ['por_br', 'pt_br', 'Indo-European'],
        _tr('wl_settings_global', 'Portuguese (Portugal)'): ['por_pt', 'pt_pt', 'Indo-European'],
        _tr('wl_settings_global', 'Punjabi (Gurmukhi script)'): ['pan_guru', 'pa_guru', 'Indo-European'],
        _tr('wl_settings_global', 'Quechua'): ['que', 'qu', 'Quechuan'],
        _tr('wl_settings_global', 'Romanian'): ['ron', 'ro', 'Indo-European'],
        _tr('wl_settings_global', 'Russian'): ['rus', 'ru', 'Indo-European'],
        _tr('wl_settings_global', 'Russian (Old)'): ['orv', 'orv', 'Indo-European'],
        _tr('wl_settings_global', 'Sámi (Northern)'): ['sme', 'se', 'Uralic'],
        _tr('wl_settings_global', 'Samoan'): ['smo', 'sm', 'Austronesian'],
        _tr('wl_settings_global', 'Sanskrit'): ['san', 'sa', 'Indo-European'],
        _tr('wl_settings_global', 'Scottish Gaelic'): ['gla', 'gd', 'Indo-European'],
        _tr('wl_settings_global', 'Serbian (Cyrillic script)'): ['srp_cyrl', 'sr_cyrl', 'Indo-European'],
        _tr('wl_settings_global', 'Serbian (Latin script)'): ['srp_latn', 'sr_latn', 'Indo-European'],
        _tr('wl_settings_global', 'Shona'): ['sna', 'sn', 'Niger-Congo'],
        _tr('wl_settings_global', 'Sindhi'): ['snd', 'sd', 'Indo-European'],
        _tr('wl_settings_global', 'Sinhala'): ['sin', 'si', 'Indo-European'],
        _tr('wl_settings_global', 'Slovak'): ['slk', 'sk', 'Indo-European'],
        _tr('wl_settings_global', 'Slovene'): ['slv', 'sl', 'Indo-European'],
        _tr('wl_settings_global', 'Somali'): ['som', 'so', 'Afro-Asiatic'],
        _tr('wl_settings_global', 'Sorbian (Lower)'): ['dsb', 'dsb', 'Indo-European'],
        _tr('wl_settings_global', 'Sorbian (Upper)'): ['hsb', 'hsb', 'Indo-European'],
        _tr('wl_settings_global', 'Sotho (Northern)'): ['nso', 'nso', 'Niger-Congo'],
        _tr('wl_settings_global', 'Sotho (Southern)'): ['sot', 'st', 'Niger-Congo'],
        _tr('wl_settings_global', 'Spanish'): ['spa', 'es', 'Indo-European'],
        _tr('wl_settings_global', 'Sundanese (Latin script)'): ['sun_latn', 'su_latn', 'Austronesian'],
        _tr('wl_settings_global', 'Swahili'): ['swa', 'sw', 'Niger-Congo'],
        _tr('wl_settings_global', 'Swedish'): ['swe', 'sv', 'Indo-European'],
        _tr('wl_settings_global', 'Tagalog'): ['tgl', 'tl', 'Austronesian'],
        _tr('wl_settings_global', 'Tajik'): ['tgk', 'tg', 'Indo-European'],
        _tr('wl_settings_global', 'Tamil'): ['tam', 'ta', 'Dravidian'],
        _tr('wl_settings_global', 'Tatar'): ['tat', 'tt', 'Turkic'],
        _tr('wl_settings_global', 'Telugu'): ['tel', 'te', 'Dravidian'],
        _tr('wl_settings_global', 'Tetun (Dili)'): ['tdt', 'tdt', 'Unclassified'],
        _tr('wl_settings_global', 'Thai'): ['tha', 'th', 'Tai-Kadai'],
        _tr('wl_settings_global', 'Tibetan'): ['bod', 'bo', 'Sino-Tibetan'],
        _tr('wl_settings_global', 'Tigrinya'): ['tir', 'ti', 'Afro-Asiatic'],
        _tr('wl_settings_global', 'Tsonga'): ['tso', 'ts', 'Niger-Congo'],
        _tr('wl_settings_global', 'Tswana'): ['tsn', 'tn', 'Niger-Congo'],
        _tr('wl_settings_global', 'Turkish'): ['tur', 'tr', 'Turkic'],
        _tr('wl_settings_global', 'Turkmen'): ['tuk', 'tk', 'Turkic'],
        _tr('wl_settings_global', 'Ukrainian'): ['ukr', 'uk', 'Indo-European'],
        _tr('wl_settings_global', 'Urdu'): ['urd', 'ur', 'Indo-European'],
        _tr('wl_settings_global', 'Uyghur'): ['uig', 'ug', 'Turkic'],
        _tr('wl_settings_global', 'Uzbek'): ['uzb', 'uz', 'Turkic'],
        _tr('wl_settings_global', 'Vietnamese'): ['vie', 'vi', 'Austroasiatic'],
        _tr('wl_settings_global', 'Welsh'): ['cym', 'cy', 'Indo-European'],
        _tr('wl_settings_global', 'Wolof'): ['wol', 'wo', 'Niger-Congo'],
        _tr('wl_settings_global', 'Xhosa'): ['xho', 'xh', 'Niger-Congo'],
        _tr('wl_settings_global', 'Yiddish'): ['yid', 'yi', 'Indo-European'],
        _tr('wl_settings_global', 'Yoruba'): ['yor', 'yo', 'Niger-Congo'],
        _tr('wl_settings_global', 'Zulu'): ['zul', 'zu', 'Niger-Congo'],

        _tr('wl_settings_global', 'Other languages'): ['other', 'other', 'Unclassified']
    },
    ...
    'mapping_lang_utils': {
        ...
        'pos_taggers': {
            ...
            _tr('wl_settings_global', 'LaoNLP - SeqLabeling'): 'laonlp_seqlabeling',
        ...
        'sentiment_analyzers': {
            ...
            _tr('wl_settings_global', 'VADER - Akan sentiment analyzer'): 'vader_aka',
            ...
            _tr('wl_settings_global', 'VADER - Aymara sentiment analyzer'): 'vader_aym',
            _tr('wl_settings_global', 'VADER - Azerbaijani sentiment analyzer'): 'vader_aze',
            _tr('wl_settings_global', 'VADER - Bambara sentiment analyzer'): 'vader_bam',
            ...
            _tr('wl_settings_global', 'VADER - Bhojpuri sentiment analyzer'): 'vader_bho',
            _tr('wl_settings_global', 'VADER - Bosnian sentiment analyzer'): 'vader_bos',
            ...
            _tr('wl_settings_global', 'VADER - Cebuano sentiment analyzer'): 'vader_ceb',
            _tr('wl_settings_global', 'VADER - Chewa sentiment analyzer'): 'vader_nya',
            ...
            _tr('wl_settings_global', 'VADER - Corsican sentiment analyzer'): 'vader_cos',
            ...
            _tr('wl_settings_global', 'VADER - Dogri (Devanagari script) sentiment analyzer'): 'vader_doi_deva',
            ...
            _tr('wl_settings_global', 'VADER - Ewe sentiment analyzer'): 'vader_ewe',
            ...
            _tr('wl_settings_global', 'VADER - Frisian (West) sentiment analyzer'): 'vader_fry',
            ...
            _tr('wl_settings_global', 'VADER - Guarani sentiment analyzer'): 'vader_grn',
            _tr('wl_settings_global', 'VADER - Gujarati sentiment analyzer'): 'vader_guj',
            _tr('wl_settings_global', 'VADER - Haitian Creole sentiment analyzer'): 'vader_hat',
            _tr('wl_settings_global', 'VADER - Hausa sentiment analyzer'): 'vader_hau',
            _tr('wl_settings_global', 'VADER - Hawaiian sentiment analyzer'): 'vader_haw',
            ...
            _tr('wl_settings_global', 'VADER - Hmong (RPA script) sentiment analyzer'): 'vader_hmn_rpa',
            ...
            _tr('wl_settings_global', 'VADER - Igbo sentiment analyzer'): 'vader_ibo',
            _tr('wl_settings_global', 'VADER - Ilocano sentiment analyzer'): 'vader_ilo',
            ...
            _tr('wl_settings_global', 'VADER - Javanese sentiment analyzer'): 'vader_jav',
            ...
            _tr('wl_settings_global', 'VADER - Kinyarwanda sentiment analyzer'): 'vader_kin',
            _tr('wl_settings_global', 'VADER - Konkani (Goan) (Devanagari script) sentiment analyzer'): 'vader_gom_deva',
            _tr('wl_settings_global', 'VADER - Korean sentiment analyzer'): 'vader_kor',
            _tr('wl_settings_global', 'VADER - Krio sentiment analyzer'): 'vader_kri',
            _tr('wl_settings_global', 'VADER - Kurdish (Kurmanji) sentiment analyzer'): 'vader_kmr',
            _tr('wl_settings_global', 'VADER - Kurdish (Sorani) sentiment analyzer'): 'vader_ckb',
            _tr('wl_settings_global', 'VADER - Kyrgyz sentiment analyzer'): 'vader_kir',
            _tr('wl_settings_global', 'VADER - Laos sentiment analyzer'): 'vader_lao',
            ...
            _tr('wl_settings_global', 'VADER - Lingala sentiment analyzer'): 'vader_lin',
            ...
            _tr('wl_settings_global', 'VADER - Maithili sentiment analyzer'): 'vader_mai',
            _tr('wl_settings_global', 'VADER - Malagasy sentiment analyzer'): 'vader_mlg',
            ...
            _tr('wl_settings_global', 'VADER - Maldivian sentiment analyzer'): 'vader_div',
            _tr('wl_settings_global', 'VADER - Maltese sentiment analyzer'): 'vader_mlt',
            _tr('wl_settings_global', 'VADER - Māori sentiment analyzer'): 'vader_mri',
            ...
            _tr('wl_settings_global', 'VADER - Mizo sentiment analyzer'): 'vader_lus',
            ...
            _tr('wl_settings_global', 'VADER - Oromo sentiment analyzer'): 'vader_orm',
            _tr('wl_settings_global', 'VADER - Pashto sentiment analyzer'): 'vader_pus',
            ...
            _tr('wl_settings_global', 'VADER - Quechua sentiment analyzer'): 'vader_que',
            ...
            _tr('wl_settings_global', 'VADER - Samoan sentiment analyzer'): 'vader_smo',
            ...
            _tr('wl_settings_global', 'VADER - Shona sentiment analyzer'): 'vader_sna',
            ...
            _tr('wl_settings_global', 'VADER - Somali sentiment analyzer'): 'vader_som',
            _tr('wl_settings_global', 'VADER - Sotho (Northern) sentiment analyzer'): 'vader_nso',
            _tr('wl_settings_global', 'VADER - Sotho (Southern) sentiment analyzer'): 'vader_sot',
            _tr('wl_settings_global', 'VADER - Spanish sentiment analyzer'): 'vader_spa',
            _tr('wl_settings_global', 'VADER - Sundanese (Latin script) sentiment analyzer'): 'vader_sun_latn',
            ...
            _tr('wl_settings_global', 'VADER - Tsonga sentiment analyzer'): 'vader_tso',
            _tr('wl_settings_global', 'VADER - Turkish sentiment analyzer'): 'vader_tur',
            _tr('wl_settings_global', 'VADER - Turkmen sentiment analyzer'): 'vader_tuk',
            ...
            _tr('wl_settings_global', 'VADER - Uzbek sentiment analyzer'): 'vader_uzb',
            _tr('wl_settings_global', 'VADER - Welsh sentiment analyzer'): 'vader_cym',
            _tr('wl_settings_global', 'VADER - Xhosa sentiment analyzer'): 'vader_xho',
            _tr('wl_settings_global', 'VADER - Yiddish sentiment analyzer'): 'vader_yid',
