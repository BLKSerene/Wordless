...
class Wrapper_Wordlist_Generator(wl_layouts.Wl_Wrapper):
    def __init__(self, main):
        ...
        layout_results.addWidget(self.table_wordlist_generator.button_results_sample, 0, 2)
        layout_results.addWidget(self.table_wordlist_generator.button_results_filter, 0, 3)
        layout_results.addWidget(self.table_wordlist_generator.button_results_search, 0, 4)
...
class Wl_Table_Wordlist_Generator(wl_tables.Wl_Table_Data):
