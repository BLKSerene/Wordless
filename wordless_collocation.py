...
class Wrapper_Collocation(wordless_layout.Wordless_Wrapper):
    def __init__(self, main):
        ...
        self.wrapper_table.layout().addWidget(self.table_collocation.label_number_results, 0, 0)
        self.wrapper_table.layout().addWidget(self.table_collocation.button_search_results, 0, 4)
        ...
        self.table_collocation.itemChanged.connect(self.table_item_changed)
    ...
    def table_item_changed(self):
        settings = self.table_collocation.settings['collocation']
        ...
        self.combo_box_freq_filter_data.addItem(main.tr('Frequency'))
        ...
        if self.combo_box_freq_filter_data.findText(freq_filter_data_old) > -1:
            ...
            self.combo_box_freq_filter_data.setCurrentText(self.main.settings_default['collocation']['filter_settings']['freq_filter_data'])
