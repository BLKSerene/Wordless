...
class Wrapper_Colligation(wordless_layout.Wordless_Wrapper):
    ...
    def generation_settings_changed(self):
        ...
        # Use Data
        use_data_old = self.main.settings_custom['colligation']['plot_settings']['use_data']
        ...
        if self.combo_box_use_data.findText(use_data_old) > -1:
            ...
            self.combo_box_use_data.setCurrentText(self.main.settings_default['colligation']['plot_settings']['use_data'])
    ...
    def plot_settings_changed(self):
        settings = self.main.settings_custom['colligation']['plot_settings']
