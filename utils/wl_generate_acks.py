...
ACKS = [
    ['Beautiful Soup', 'https://www.crummy.com/software/BeautifulSoup/', '4.12.3', 'Leonard Richardson', 'MIT', 'https://git.launchpad.net/beautifulsoup/tree/LICENSE'],
    ...
    ['Matplotlib', 'https://matplotlib.org/', '3.8.0', 'Matplotlib Development Team', 'Matplotlib', 'https://matplotlib.org/stable/users/project/license.html'],
    ['NetworkX', 'https://networkx.org/', '3.1', 'NetworkX Developers, Aric Hagberg, Dan Schult,<br>Pieter Swart', 'BSD-3-Clause', 'https://github.com/networkx/networkx/blob/main/LICENSE.txt'],
    ['NLTK', 'https://www.nltk.org/', '3.8.1', 'Steven Bird, Edward Loper, Ewan Klein', 'Apache-2.0', 'https://github.com/nltk/nltk/blob/develop/LICENSE.txt'],
    ['NumPy', 'https://www.numpy.org/', '1.26.0', 'NumPy Developers', 'BSD-3-Clause', 'https://github.com/numpy/numpy/blob/main/LICENSE.txt'],
    ...
    ['Sacremoses', 'https://github.com/hplt-project/sacremoses', '0.1.1', 'Liling Tan, Jelmer van der Linde', 'MIT', 'https://github.com/hplt-project/sacremoses/blob/master/LICENSE'],
    ['SciPy', 'https://scipy.org/scipylib/', '1.11.3', 'SciPy Developers', 'BSD-3-Clause', 'https://github.com/scipy/scipy/blob/main/LICENSE.txt'],
    ...
    ['SudachiPy', 'https://github.com/WorksApplications/sudachi.rs', '0.6.8', 'Works Applications Co., Ltd.', 'Apache-2.0', 'https://github.com/WorksApplications/sudachi.rs/blob/develop/LICENSE'],
    ...
    ['VADER', 'https://github.com/cjhutto/vaderSentiment', '3.3.2', 'C.J. Hutto', 'MIT', 'https://github.com/cjhutto/vaderSentiment/blob/master/LICENSE.txt'],
