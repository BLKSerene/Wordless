...
def init(self):
    ...
    def filter_settings_changed():
        ...
        self.settings['wordlist']['freq_first_min'] = spinbox_freq_first_min.value()
        ...
        self.settings['wordlist']['freq_total_min'] = spinbox_freq_total_min.value()
        ...
        self.settings['wordlist']['rank_min'] = spinbox_rank_min.value()
        ...
        self.settings['wordlist']['len_min'] = spinbox_len_min.value()
        ...
        self.settings['wordlist']['files_min'] = spinbox_files_min.value()
    ...
    def restore_defaults():
        ...
        spinbox_freq_first_min.setValue(self.default_settings['wordlist']['freq_first_min'])
        spinbox_freq_first_max.setValue(self.default_settings['wordlist']['freq_first_max'])
        checkbox_freq_total.setChecked(self.default_settings['wordlist']['freq_total_no_limit'])
        spinbox_freq_total_min.setValue(self.default_settings['wordlist']['freq_total_min'])
        spinbox_freq_total_max.setValue(self.default_settings['wordlist']['freq_total_max'])
        checkbox_rank.setChecked(self.default_settings['wordlist']['rank_no_limit'])
        spinbox_rank_min.setValue(self.default_settings['wordlist']['rank_min'])
        spinbox_rank_max.setValue(self.default_settings['wordlist']['rank_max'])
        checkbox_len.setChecked(self.default_settings['wordlist']['len_no_limit'])
        spinbox_len_min.setValue(self.default_settings['wordlist']['len_min'])
        spinbox_len_max.setValue(self.default_settings['wordlist']['len_max'])
        checkbox_files.setChecked(self.default_settings['wordlist']['files_no_limit'])
        spinbox_files_min.setValue(self.default_settings['wordlist']['files_min'])
        spinbox_files_max.setValue(self.default_settings['wordlist']['files_max'])
